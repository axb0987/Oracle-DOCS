# Log Files
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/msadbridge/understand-best-practices-microsoft-active-directory-ad-bridge.htm
...
- Navigate to the`%ProgramFiles%\Oracle\IDBridge`directory.
- Using a text editor, open the`log4net.config`file.
- In the file, locate the following line of code:`<level value="info" />`
- Change the value of the`level value`parameter to one of the following log levels:
...
You must restart the AD bridge for the change you made to the log level to take effect. See[Restarting the Microsoft Active Directory Bridge](https://docs.oracle.com/en-us/iaas/Content/Identity/msadbridge/maintain-microsoft-active-directory-ad-bridge.htm#restart-microsoft-active-directory-ad-bridge)
