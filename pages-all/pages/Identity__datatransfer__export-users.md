# Exporting Users
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/datatransfer/export-users.htm
...
- Select the checkbox for each user that you want to export.
- From the More actions menu, select Export users .
- In the Export users window, select Export .
