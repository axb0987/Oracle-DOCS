# Connecting a VMware Solution SDDC to the Oracle Services Network
- Source: https://docs.oracle.com/en-us/iaas/Content/VMware/Tasks/ocvsconfigconnectivity_topic-Configuring_Connectivity_to_the_Oracle_Services_Network.htm
- Fetched: 2026-09-05 03:09 CDT

# Connecting a VMware Solution SDDC to the Oracle Services Network

Use a quick action workflow in the Console to connect your SDDC to the Oracle Services Network.
...
- On the details page, select Configure connectivity to Oracle Services Network .
...
- Select Next .
- Review the details of the planned updates to your networking resources. The workflow creates or updates route tables and rules that impact the NSX Edge Uplink1 VLAN and the service gateway.

If you disallow an update, your SDDC might not have connectivity to Oracle Services Network. To complete the configuration, you can either return to the workflow later or make the required resource update manually outside of the workflow.
