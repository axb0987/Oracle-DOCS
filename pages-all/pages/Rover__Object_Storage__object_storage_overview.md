...
- Source: https://docs.oracle.com/en-us/iaas/Content/Rover/Object_Storage/object_storage_overview.htm
...
[Buckets](https://docs.oracle.com/en-us/iaas/Content/Rover/Object_Storage/Bucket/bucket_management.htm#BucketManagement)
- 

[Objects](https://docs.oracle.com/en-us/iaas/Content/Rover/Object_Storage/Object/object_management.htm#ObjectManagement)
...
Regularly monitor the available storage space for all your Roving Edge Infrastructure devices. See[Roving Edge Infrastructure Device Monitoring](https://docs.oracle.com/en-us/iaas/Content/Rover/Object_Storage/../Device_Monitoring/device_monitoring.htm#NodeManagement).
...
[https://s3tools.org/download](https://s3tools.org/download)
...
For more details, reference:[https://s3tools.org/kb/item14.htm](https://s3tools.org/kb/item14.htm)

The following example shows contents of the S3cmd configuration file:
```
...
Update the access_key field:
- 

Log into the Roving Edge Infrastructure Device Console of the appropriate device.
- 
...
Select the user whose access key you want to use in the S3cmd configuration file. The user's Details page appears.
- 
...
Copy the access key and past it into the access_key field value in the s3cmd configuration file.
- 

Update the ca_certs_file field: Enter the full path of your`bundle.pem`file, for example:
```
...
Set the check_ssl_hostname field to`false`.
- 
...
Select the user whose secret key you want to use in the S3cmd configuration file. The user's Details page appears.
- 

Select Customer Secret Keys under Resources . The Customer Secret Keys page appears. All customer secret keys are listed in tabular form.
- 

Select Generate Secret Key . The generated Secret Key is displayed in the Generate Secret Key dialog box. At the same time, Oracle generates the Access Key that is paired with the Secret Key . The newly generated Customer Secret key is added to the list of Customer Secret Keys .
- 
...
If you are unable to install using a pre-built package, follow the compilation instructions here:[https://github.com/s3fs-fuse/s3fs-fuse/blob/master/COMPILATION.md](https://github.com/s3fs-fuse/s3fs-fuse/blob/master/COMPILATION.md).
- 
Review and perform the prerequisites in[Setting up Access to Oracle Cloud Infrastructure](https://docs.oracle.com/en-us/iaas/Content/Rover/Object_Storage/object_storage_overview.htm#usingAPI). You need an Access Key/Secret Key pair and a proper IAM policy that lets you mount a bucket as a file system. For example:
