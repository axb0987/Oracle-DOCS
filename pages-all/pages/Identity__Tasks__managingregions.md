# Managing Regions
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/managingregions.htm
...
For more information about identity domains, see[Managing Identity Domains](https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/../domains/overview.htm)
...
Yes. You can write policies that grant permissions in a specified region only. For an example policy, see[Restrict admin access to a specific region](https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/../Concepts/commonpolicies.htm#restrict-admin-to-specific-region).
