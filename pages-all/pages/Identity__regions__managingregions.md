# Managing Regions
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/regions/managingregions.htm
- Fetched: 2026-09-05 02:27 CDT

# Managing Regions

This topic describes the basics of managing your region subscriptions. For more information about regions in Oracle Cloud Infrastructure, see[Regions and Availability Domains](https://docs.oracle.com/iaas/Content/General/Concepts/regions.htm). For information about Platform Services regions, see[Managing Platform Services Regions](https://docs.oracle.com/en-us/iaas/Content/Identity/regions/../platformsvcregions/managingregionsplatform.htm).
...
- [Provisioning SaaS Applications and Geo-Regions](https://docs.oracle.com/en-us/iaas/Content/Identity/regions/managingregions.htm#provisioning_saas_applications_geo_regions)
- [Find Out More](https://docs.oracle.com/en-us/iaas/Content/Identity/regions/managingregions.htm#regfaq)
- [Listing Infrastructure Regions](https://docs.oracle.com/en-us/iaas/Content/Identity/regions/To_view_the_list_of_infrastructure_regions.htm)
- [Listing Subscribed Infrastructure Regions](https://docs.oracle.com/en-us/iaas/Content/Identity/regions/list_subscribed_infrastructure_regions.htm)
- [Subscribing to an Infrastructure Region](https://docs.oracle.com/en-us/iaas/Content/Identity/regions/To_subscribe_to_an_infrastructure_region.htm)

## Required IAM Policy

If you're in the Administrators group, then you have the required access to manage region subscriptions.

If you're new to policies, see[IAM Policies Overview](https://docs.oracle.com/en-us/iaas/Content/Identity/regions/../policieshow/Policy_Basics.htm),.
...
For more information about identity domains, see[Managing Identity Domains](https://docs.oracle.com/en-us/iaas/Content/Identity/regions/../domains/overview.htm)
