# Managing Users
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/managingusers.htm
...
If your tenancy is federated with Oracle Identity Cloud Service, see[Managing Oracle Identity Cloud Service Users and Groups in the Oracle Cloud Infrastructure Console](https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/addingidcsusersandgroups.htm#Managing_Oracle_Identity_Cloud_Service_Users_and_Groups_in_the_Oracle_Cloud_Infrastructure_Console)to manage users.

## Required IAM Policy

If you're in the Administrators group, then you have the required access for managing users.
- You can create a policy that gives someone the power to create new users and credentials but not control which groups those users are in. See[Let the Help Desk manage users](https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/../Concepts/commonpolicies.htm#helpdesk-manage-users).

If you're new to policies, see[Getting Started with Policies](https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/../Concepts/policygetstarted.htm#Getting_Started_with_Policies)and[Common Policies](https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/../Concepts/commonpolicies.htm#top). If you want to dig deeper into writing policies for users or other IAM components, see[Details for IAM without Identity Domains](https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/../Reference/iampolicyreference.htm#top).
...
For information about the number of users you can have, see[Limits by Service](https://docs.oracle.com/iaas/Content/General/service-limits/default.htm).
...
- Open the navigation menu and select Identity &amp; Security . Under Identity , select Users . A list of the users in your tenancy is displayed.
- Locate the user in the list.
- Select the user. The user's details are displayed.
- Select Groups .
...
- Open the navigation menu and select Identity &amp; Security . Under Identity , select Users . A list of the users in your tenancy is displayed.
- For the user you want to delete, select Delete .
- Confirm when prompted.
...
- Open the navigation menu and select Identity &amp; Security . Under Identity , select Users . A list of the users in your tenancy is displayed.
- Select the user. The user's details are displayed, including the current status.
- Select Unblock .
- Confirm when prompted.
...
- Edit the description and save it.

[To edit a user's email](https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/managingusers.htm#)

- Open the navigation menu and select Identity &amp; Security . Under Identity , select Users . A list of the users in your tenancy is displayed.
- Select the user you want to update. The user's details are displayed.
- Under User Information , select the pencil next to Email .
- Enter the email address and select the save icon. The email address must be unique in the tenancy.
...
- Open the navigation menu and select Identity &amp; Security . Under Identity , select Users . A list of the users in your tenancy is displayed.
- Select the user you want to update. The user's details are displayed.
- Select Unlink Support Account .
- In the confirmation prompt, select Unlink .
