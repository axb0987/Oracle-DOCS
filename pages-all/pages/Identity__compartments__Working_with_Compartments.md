...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/compartments/Working_with_Compartments.htm
...
- [Limits on Compartments](https://docs.oracle.com/en-us/iaas/Content/Identity/compartments/Working_with_Compartments.htm#compartment-limits)
...
Item Description
Two compartments within the same parent can't have the same name. Therefore you can't move a compartment to a destination compartment where a compartment with the same name already exists.
...
The policy is automatically updated. Group G1 does not lose permissions.
...
Item Description
Policy: Allow group G1 to manage buckets in compartment A
Policy: Allow group G1 to manage buckets in compartment A
The policy isn't updated. Group G1 loses this permission. This policy is invalid and must be manually removed.
...
Item Description
Policy: Allow group G1 to manage buckets in compartment Operations:Test:A
Policy: Allow group G1 to manage buckets in compartment HR:Prod:A
The policy is automatically updated. Group G1 does not lose permissions.
...
Item Description
All the resources in CompartmentB are tagged with the default tags defined for its parent, CompartmentA.
