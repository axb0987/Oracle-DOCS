...
- Source: https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/devtools.htm
...
Launch the Create stack page for the Oracle Cloud Development Kit template by selecting this button:
...
- In the Create stack page, select Template .
- Under Stack configuration , select Select template .
- In the Browse templates panel, select Architecture .
- Select Oracle Cloud development kit .
Note  
...
[Follow the prompts to save your new stack and provision the instance](https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/devtools.htm#)
...
Select the check box for Run apply .

This option automatically provisions the instance on stack creation.
- 

Select Create to create your stack and automatically provision the instance.
...
The new apply job is listed under Jobs . Monitor its status: "Succeeded" indicates that the job has completed. While the job runs, or after it finishes, you can[download its log file](https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/get-job-logs.htm).
...
To view the Terraform state file (shows the state of your resources after running the job), select the apply job ([get its details](https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/get-job.htm)) and then select View state under Resources .
...
- Go to the Stack details page for your newly provisioned instance:
...
- Select the Application information tab.
- Copy the value for Compute Instance Public IP .
- For the private key, follow the steps that correspond to the key option you selected while creating your stack:
...
Usage: See[https://godoc.org/github.com/oracle/oci-go-sdk](https://godoc.org/github.com/oracle/oci-go-sdk)
...
- [Connect to the instance that you provisioned from the Oracle Cloud development kit template.
