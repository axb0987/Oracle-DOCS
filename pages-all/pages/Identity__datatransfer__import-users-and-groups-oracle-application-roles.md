...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/datatransfer/import-users-and-groups-oracle-application-roles.htm
...
- In the Applications page, select the Oracle application that has roles to which you want to assign users and groups.
...
- In the Import application roles window, drag and drop the file or select Select one to browse for the file.

Note  
  
Select Download sample file in the dialog box to download a sample file.
- Select Import .
