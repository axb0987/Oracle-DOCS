...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/policyreference/javamanagementreference.htm
...
JMS_PLUGIN_UPDATE`UpdateJmsPlugin`
...
JMS_PLUGIN_CREATE+JMS_PLUGIN_DELETE
...
[application-analyses](https://docs.oracle.com/en-us/iaas/Content/Identity/policyreference/javamanagementreference.htm#)
...
[utils-work-requests](https://docs.oracle.com/en-us/iaas/Content/Identity/policyreference/javamanagementreference.htm#)

Verbs Permissions APIs Fully Covered APIs Partially Covered
inspect

UTILS_WORK_REQUEST_INSPECT
...
UTILS_WORK_REQUEST_DELETE

`CancelWorkRequest`

none

[subscription-ack-configs](https://docs.oracle.com/en-us/iaas/Content/Identity/policyreference/javamanagementreference.htm#)
...
API Operation Permissions Required to Use the Operation
`CancelWorkRequest`UTILS_WORK_REQUEST_DELETE
...
`GetWorkRequest`UTILS_WORK_REQUEST_READ
`ListJavaMigrationAnalyses`APPLICATION_ANALYSIS_INSPECT
`ListPerformanceTuningAnalyses`APPLICATION_ANALYSIS_INSPECT
`ListWorkItems`UTILS_WORK_REQUEST_INSPECT
`ListWorkRequestErrors`UTILS_WORK_REQUEST_INSPECT
`ListWorkRequestLogs`UTILS_WORK_REQUEST_INSPECT
`ListWorkRequests`UTILS_WORK_REQUEST_INSPECT
