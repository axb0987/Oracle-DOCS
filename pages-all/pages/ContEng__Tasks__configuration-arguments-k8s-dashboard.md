# Kubernetes Dashboard (not recommended)
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/configuration-arguments-k8s-dashboard.htm
...
We do not recommend deploying the Kubernetes Dashboard on production clusters due to the lack of continued support for this project. For more information, see[Accessing a Cluster Using the Kubernetes Dashboard](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengstartingk8sdashboard.htm).

[Configuration Arguments Common to most Cluster Add-ons](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/configuration-arguments-k8s-dashboard.htm#)
...
[Configuration Arguments Specific to this Cluster Add-on](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/configuration-arguments-k8s-dashboard.htm#)
