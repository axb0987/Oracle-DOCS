...
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/capture-filter-create.htm
...
- On the Capture filters list page, select Create capture filter . If you need help finding the list page, see[Listing Capture Filters](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/capture-filter-list.htm#top).
...
- (Optional) To apply one or more tags to the filter, select Show advanced options .
...
Run the[CreateCaptureFilter](https://docs.oracle.com/iaas/api/#/en/iaas/latest/CaptureFilter/CreateCaptureFilter)
