...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/applications/enterprise-applications.htm
...
Identify URL patterns that apply to your list of resources. In the previous example, the URL pattern`/myapp/private/.*`
