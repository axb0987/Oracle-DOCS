...
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengprereqsforselfmanagednodes.htm
...
The Oracle Linux image you specify for a self-managed node must be one of the OKE Oracle Linux 7 (OL7) or Oracle Linux 8 (OL8) images. The image must have a Release Date of March 28, 2023 or later. Do not specify an image with a name that ends with`-878`(such as`Oracle-Linux-8.10-aarch64-2025.06.17-0-OKE-1.33.1-878`).
