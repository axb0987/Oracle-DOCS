...
- Source: https://docs.oracle.com/en-us/iaas/Content/General/domain/update-domaingov.htm
...
For an active domain, you can only enable or disable governance or update the email address. To enable governance for an active domain, see[Enabling Domain Governance](https://docs.oracle.com/en-us/iaas/Content/General/domain/create-domaingov.htm). For more information on updating an email address, see[Editing Domains](https://docs.oracle.com/en-us/iaas/Content/General/domain/update-domain.htm).
- 
...
Run the[UpdateDomainGovernance](https://docs.oracle.com/iaas/api/#/en/organizations/latest/DomainGovernance/UpdateDomainGovernance)
