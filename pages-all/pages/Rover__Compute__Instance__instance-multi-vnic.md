...
- Source: https://docs.oracle.com/en-us/iaas/Content/Rover/Compute/Instance/instance-multi-vnic.htm
...
- [Create and attach a secondary VNIC](https://docs.oracle.com/en-us/iaas/Content/Rover/Compute/Instance/../../Network/VNIC/attach_vnic.htm#top)to the instance. Keep the VNIC OCID handy so you can provide it later when you run the configuration script.
- [Connect to the instance](https://docs.oracle.com/iaas/Content/Compute/Tasks/accessinginstance.htm)with Remote Desktop.
