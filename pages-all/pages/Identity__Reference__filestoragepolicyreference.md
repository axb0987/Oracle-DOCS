...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/Reference/filestoragepolicyreference.htm
...
If creating a file system or clone encrypted with a Key Management master encryption key , also need`use key-delegate`(for the caller) and`read keys`(for the service principal). For more information, see policy details for your service.
...
FILESYSTEM_SNAPSHOT​_POLICY_INSPECT`ListFilesystemSnapshotPolicies`
...
FILESYSTEM_SNAPSHOT​_POLICY_READ`ListFilesystemSnapshotPolicies`
...
FILE_SYSTEM_UPDATE​_FILESYSTEM_SNAPSHOT_POLICY`ListFilesystemSnapshotPolicies`
...
FILESYSTEM_SNAPSHOT​_POLICY_DELETE`ListFilesystemSnapshotPolicies`
...
[fss-work-requests](https://docs.oracle.com/en-us/iaas/Content/Identity/Reference/filestoragepolicyreference.htm#)
...
If a group uses the Console to create file systems, permissions to read mount targets is required.[See the File Storage policy examples](https://docs.oracle.com/en-us/iaas/Content/Identity/Reference/../Concepts/commonpolicies.htm#create-file-system)for further guidance.
