...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/TLSGT.htm
...
- As part of the TLS handshake, the client application presents its own certificate and Client ID to obtain an access token. Note: This certificate must match the certificate in the client certificate store.
...
See[TLS Client Authentication Grant Type Authorization Flow Example](https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/TLSGT.htm#TLSAuthFlow)for an example flow.
...
See[TLS Client Authentication Grant Type](https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/TLSGT.htm)for more information on the TLS Client Authentication grant type and an authorization flow diagram.

- 

A client-initiated event (for example, a scheduled task) requests access to protected resources from an OAuth client application.
...
- The client application requests an access token from the OAuth Authorization Server.
- The OAuth Authorization Server:
- Authenticates the client application based on the certificate sent as part of TLS handshake.
- Returns an access token containing all applicable scopes based on the privileges specified by the application roles granted to the requesting client application.
-
