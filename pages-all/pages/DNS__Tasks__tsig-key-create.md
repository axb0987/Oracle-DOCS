# Creating a TSIG Key
- Source: https://docs.oracle.com/en-us/iaas/Content/DNS/Tasks/tsig-key-create.htm
...
- On the TSIG keys list page, select Create TSIG key . If you need help finding the list page, see[Listing TSIG Keys](https://docs.oracle.com/en-us/iaas/Content/DNS/Tasks/tsig-key-list.htm#top).
- In the Create TSIG Key panel, enter the following information:
...
Run the[CreateTsigKey](https://docs.oracle.com/iaas/api/#/en/dns/latest/TsigKey/CreateTsigKey)
