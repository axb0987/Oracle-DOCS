# Viewing Default Metric Charts for All Streams
- Source: https://docs.oracle.com/en-us/iaas/Content/Streaming/Tasks/view-chart-namespace.htm
- Fetched: 2026-09-05 03:06 CDT

# Viewing Default Metric Charts for All Streams

Go to the Service Metrics page in the Console to view metric charts that use predefined service queries for`oci_streaming`. The charts show metric data for all streams in the selected compartment and region.
...
- For Metric namespace , select oci_streaming .

The Service Metrics page displays default charts for all streams in the selected region and compartment that emit metric data to the`oci_streaming`metric namespace.
