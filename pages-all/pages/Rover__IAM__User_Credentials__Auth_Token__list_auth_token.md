...
- Source: https://docs.oracle.com/en-us/iaas/Content/Rover/IAM/User_Credentials/Auth_Token/list_auth_token.htm
...
- [Console](https://docs.oracle.com/en-us/iaas/Content/Rover/IAM/User_Credentials/Auth_Token/list_auth_token.htm#)
- [CLI](https://docs.oracle.com/en-us/iaas/Content/Rover/IAM/User_Credentials/Auth_Token/list_auth_token.htm#)
- [API](https://docs.oracle.com/en-us/iaas/Content/Rover/IAM/User_Credentials/Auth_Token/list_auth_token.htm#)
- 
...
Use the[oci iam auth-token list](https://docs.oracle.com/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/iam/auth-token/list.html)command and required parameters to list the auth token credentials for a user on your Roving Edge Infrastructure devices:
