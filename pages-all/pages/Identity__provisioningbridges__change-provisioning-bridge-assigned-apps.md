...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/provisioningbridges/change-provisioning-bridge-assigned-apps.htm
...
- Select the App Catalog app to which you want to assign a different provisioning bridge.
...
- Select the provisioning bridge that you unassigned from the apps, and then select the Apps tab.
-
