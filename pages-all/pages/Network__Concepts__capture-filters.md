# Capture Filters
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Concepts/capture-filters.htm
...
For more information, see[Flow Logs](https://docs.oracle.com/en-us/iaas/Content/Network/Concepts/vcn-flow-logs.htm)and[Virtual Test Access Points (VTAPs)](https://docs.oracle.com/en-us/iaas/Content/Network/Concepts/../Tasks/vtap.htm).
...
- Source CIDR: 10.1.1.1/32, Exclude
- Source CIDR: 0.0.0.0/0, Include
Note  
  
Using 0.0.0.0/0 to log packets can produce a large amount of log data.
