...
- Source: https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/create-stack-bucket.htm
...
- Under Stack configuration , select Object Storage bucket and then select the bucket that you want.
...
Use the`[](https://docs.oracle.com/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/resource-manager/stack/create-from-object-storage.html)oci resource-manager stack create-from-object-storage`command and required parameters to create a stack from a bucket.
