# DRG Metrics
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Reference/drgmetrics.htm
...
This feature is only available for upgraded DRGs and not for legacy DRGs.
...
The number of bytes sent from the DRG through the DRG attachment.
- 
...
The number of bytes sent to the DRG from the DRG attachment.
- 
...
Packets sent from DRG

Packets

Number of packets sent from the DRG through the DRG attachment.
- 
...
Number of packets sent from the DRG attachment to the DRG.
- 
...
Dropped packets bound for the DRG attachment

Packets

The number of dropped packets bound for the DRG attachment.
- 
...
Packets from the DRG attachment sent to the DRG then dropped

Packets

The number of packets sent from the DRG attachment and dropped by the DRG.
- 
...
- For Metric Namespace , select oci_dynamic_routing_gateway .
