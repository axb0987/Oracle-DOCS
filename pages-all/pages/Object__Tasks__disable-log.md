# Disabling and Re-Enabling an Object Storage Bucket's Log
- Source: https://docs.oracle.com/en-us/iaas/Content/Object/Tasks/disable-log.htm
- Fetched: 2026-09-05 02:50 CDT

# Disabling and Re-Enabling an Object Storage Bucket's Log

Disable and then re-enable a read access events and write access events log for a bucket.
...
- From the Actions menu for the log you want, select Delete .
