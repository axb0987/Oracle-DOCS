...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/access/working-with-auth-tokens.htm
...
Auth tokens don't expire. Each user can have up to two auth tokens at a time. To get an auth token in the Console, see[Creating an Auth Token](https://docs.oracle.com/en-us/iaas/Content/Identity/access/to_create_an_auth_token.htm)
