# Listing Job Outputs
- Source: https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/list-job-outputs.htm
...
These steps show how to list outputs for a job in a compartment. You can also list outputs for a job[in a stack](https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/get-stack.htm).
...
- On the job's details page, select Outputs .
Don't see Outputs ? Check that the job has finished running, and that it's either an[apply job](https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/create-job-apply.htm)or an[apply rollback job](https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/create-job-apply-rollback.htm). Outputs are generated at the same time as the job's[state file](https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/get-job-tf-state.htm). No outputs are available for[canceled](https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/cancel-job.htm)jobs.
- 

Use the`[](https://docs.oracle.com/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/resource-manager/job-output-summary/list-job-outputs.html)oci resource-manager job-output-summary list-job-outputs`command and required parameters to list job outputs.
...
Use the[ListJobOutputs](https://docs.oracle.com/iaas/api/#/en/resourcemanager/latest/JobOutputSummary/ListJobOutputs)
