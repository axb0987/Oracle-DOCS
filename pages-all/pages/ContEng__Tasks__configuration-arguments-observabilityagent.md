# ObservabilityAgent
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/configuration-arguments-observabilityagent.htm
- Fetched: 2026-09-05 01:53 CDT

# ObservabilityAgent

When you enable the ObservabilityAgent cluster add-on, you can pass the following key/value pairs as arguments.

[Configuration Arguments Common to most Cluster Add-ons](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/configuration-arguments-observabilityagent.htm#)
...
[Configuration Arguments Specific to this Cluster Add-on](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/configuration-arguments-observabilityagent.htm#)

Key (API and CLI) Key's Display Name (Console) Description Required/Optional Default Value Example Value
`otelMetricsPort`Worker Node Metrics Port

The port on the worker node that is used to expose metrics. Optional`9995`
`otelHealthCheckPort`Opentelemetry Collector Health Check Port The port used by Kubernetes for otel collector health check. Optional`9996`
`discoveryHealthCheckPort`Otel Config Agent Health Check Port The port used by Kubernetes for otel config agent health check. Optional`9997`
