# Decrypting Data
- Source: https://docs.oracle.com/en-us/iaas/Content/KeyManagement/Tasks/ekms_decryption_data.htm
- Fetched: 2026-09-05 02:34 CDT

# Decrypting Data

Lean how to decrypt data using an AES key.

Use the[Decrypt](https://docs.oracle.com/iaas/api/#/en/key/latest/DecryptedData/Decrypt)API with the Cryptographic Endpoint to decrypt your data using an AES key.
Note  
