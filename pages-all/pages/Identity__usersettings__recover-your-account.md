...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/usersettings/recover-your-account.htm
...
- On the Oracle Cloud sign in page, confirm that you're signing in to the correct tenancy and correct identity domain and select Next .
- On the Request Password Change page, confirm your email address or user name and then select Forgot Password? .
- In the Forgot Your Password? page, enter your username, and then select Next .
- Select the Recovery email , Mobile number , or Security questions account recovery method.
- If you select Recovery email , then a Password reset notification is sent to the recovery email address associated with your account. Follow the instructions in the notification to reset your password. If you don't receive a notification, contact your administrator. If you don't know how to contact your administrator, you can find your administrator's contact information in your original Welcome email.
- If you select Mobile number , then a passcode is sent to the mobile number associated with your account. Enter the passcode, and then select Verify to reset your password.
- If you select Security questions , then one of the security questions that you set appears. Provide the answer to this security question, and then select Verify to reset your password.
...
If you need help contacting your administrator, see Contacting Your Administrator in the[Contacting Support](https://docs.oracle.com/iaas/Content/GSG/Tasks/signinginIdentityDomain.htm#contacting_support)
