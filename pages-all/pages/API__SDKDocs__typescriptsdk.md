...
- Source: https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/typescriptsdk.htm
...
Download:[GitHub](https://github.com/oracle/oci-typescript-sdk)or[NPM](https://www.npmjs.com/package/oci-sdk).
Tip  
  
The SDK for TypeScript and JavaScript is pre-installed on the Oracle Linux Cloud Developer platform image. For more information, see[Oracle Linux Cloud Developer](https://docs.oracle.com/iaas/oracle-linux/oci/developer-image.htm).
...
- A key pair used for signing API requests, with the public key uploaded to Oracle. Only the user calling the API should be in possession of the private key. For more information, see[Getting Started](https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/typescriptsdkgettingstarted.htm).
...
The SDK for TypeScript and JavaScript currently supports NodeJS version 14.x, 16.x, 20.x, and TypeScript version 4.1.x.
...
Got a fix for a bug or a new feature you'd like to contribute? The SDK is open source and[accepting pull requests](https://github.com/oracle/oci-typescript-sdk/tree/master/CONTRIBUTING.md)on[GitHub](https://github.com/oracle/oci-typescript-sdk).

### Notifications

To be notified when a new version of the SDK for TypeScript and JavaScript is released, subscribe to the[Atom feed](https://github.com/oracle/oci-typescript-sdk/releases.atom).

### Questions or Feedback
- [GitHub Issues](https://github.com/oracle/oci-typescript-sdk/issues): To file bugs and feature requests only
