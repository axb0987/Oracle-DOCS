...
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/managingvnics_tasks-attach.htm
...
- Click Create VNIC .
- In the Create VNIC dialog box, specify which VCN and subnet to put the VNIC in. By default, the VNIC is created in the current compartment. You can select a VCN and subnet from the same compartment or a different compartment.
...
- DNS record: Whether to assign the VNIC a private IPv4 DNS record. For more information, see[DNS in a Virtual Cloud Network](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/../Concepts/dns.htm).
...
- Configure the OS to use the VNIC. See[Linux: Configuring the OS for Secondary VNICs](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/managingVNICs.htm#Linux)or[Windows: Configuring the OS for Secondary VNICs](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/managingVNICs.htm#Windows).
- 
