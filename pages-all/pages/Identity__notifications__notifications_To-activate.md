...
- To activate notifications, turn on Enable notifications for all identity domain users .
- Select whether to verify the sender's domain or email address:
...
- In the Sender's email address field, enter the email address that will appear in the From email field for all notifications.
- Select Save changes .
...
- In the confirmation window, select Save changes .
- If you don't see a Verified status, then select Check Status .
