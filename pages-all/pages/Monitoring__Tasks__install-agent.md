...
- Source: https://docs.oracle.com/en-us/iaas/Content/Monitoring/Tasks/install-agent.htm
...
- Install the agent according to the same steps in[Manual Installation](https://docs.oracle.com/iaas/Content/Monitoring/Tasks/install-agent.htm#top__manual-install).
...
- Create a policy granting the dynamic group you created access to the Monitoring service.
```
