...
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengbestpractices_topic-Multi-Tenancy-best-practices.htm
- Fetched: 2026-09-05 01:54 CDT

# Multi-tenancy Best Practices

Find out about best practices for sharing one or more clusters between tenants when using Kubernetes Engine (OKE).
...
See[Using the Kubernetes Cluster Autoscaler](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengusingclusterautoscaler.htm),[Using the Kubernetes Horizontal Pod Autoscaler](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengusinghorizontalpodautoscaler.htm).
