...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/scim/overview.htm
...
Item URL
Core schema[https://tools.ietf.org/html/rfc7643](https://tools.ietf.org/html/rfc7643)
Protocol[https://tools.ietf.org/html/rfc7644](https://tools.ietf.org/html/rfc7644)
Definitions, overview, concepts, and requirements[https://tools.ietf.org/html/rfc7642](https://tools.ietf.org/html/rfc7642)
...
If your custom application has this interface, then you can configure the Generic SCIM App Template to provision users with your application. See[Configure the Generic SCIM App Template](https://docs.oracle.com/en-us/iaas/Content/Identity/scim/configure-generic-scim-app-template.htm).

If your custom application doesn't have this interface, then you can develop a custom SCIM gateway to act as the interface between IAM and your custom application. See[How Do You Develop a Custom SCIM Gateway?](https://docs.oracle.com/en-us/iaas/Content/Identity/scim/how-do-you-develop-custom-scim-gateway.htm)
