...
- Source: https://docs.oracle.com/en-us/iaas/Content/General/Concepts/credentials.htm
...
- Format: Typical password text string.
- How to get one: See[Working with Console Passwords and API Keys](https://docs.oracle.com/iaas/Content/Identity/Tasks/managingcredentials.htm#one).
-
