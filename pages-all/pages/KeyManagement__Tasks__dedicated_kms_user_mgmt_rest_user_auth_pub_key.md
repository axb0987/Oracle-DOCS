...
- Source: https://docs.oracle.com/en-us/iaas/Content/KeyManagement/Tasks/dedicated_kms_user_mgmt_rest_user_auth_pub_key.htm
...
The`resetUserAuthPubKey`command resets user authentication public key for a specified key slot.

In the User Management utility, open a command prompt and run`resetUserAuthPubKey`command to reset user authentication public key for a specified key slot.
