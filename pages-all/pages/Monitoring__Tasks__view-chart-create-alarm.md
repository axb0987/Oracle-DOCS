...
- Source: https://docs.oracle.com/en-us/iaas/Content/Monitoring/Tasks/view-chart-create-alarm.htm
- Fetched: 2026-09-05 02:40 CDT

# Creating an Alarm from a Default Metric Chart

Create an alarm based on the predefined service query used to generate a default metric chart. Default metric charts are available on the Service Metrics page and resource details pages in the Console.
...
- In the chart, select Options and select Create an alarm on this query .
The Create Alarm page opens, showing the query from the previous page.
- Provide the rest of the information needed to create the alarm.
