...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/policyreference/wafpolicyreference.htm
...
The WAF Service supports all the general variables (see[General Variables](https://docs.oracle.com/en-us/iaas/Content/Identity/policyreference/policyreference_topic-General_Variables_for_All_Requests.htm)), plus the ones listed here.
...
WAAS_CERTIFICATE_INSPECT`ListCertificates`
...
WAAS_WORK_REQUEST_INSPECT`ListWorkRequests`
...
WAAS_METERING_READ`GetWafReport`
...
WAAS_CUSTOM_PROTECTION_RULE_INSPECT`ListCustomProtectionRules`
...
WAAS_ADDRESS_LIST_INSPECT`ListAddressLists`
...
HTTPREDIRECT_INSPECT`ListHttpRedirects`
