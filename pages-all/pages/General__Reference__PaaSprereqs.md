...
- Source: https://docs.oracle.com/en-us/iaas/Content/General/Reference/PaaSprereqs.htm
...
See[Common Policies](https://docs.oracle.com/iaas/Content/Identity/Concepts/commonpolicies.htm)for more information and examples.
...
To use Autonomous AI Lakehouse Cloud , you don't need to set up any of the resources listed in this prerequisites section. However, if you optionally choose to use Oracle Cloud Infrastructure Object Storage for data loading, you need to perform these two tasks:
...
You can't use the`ManagedCompartmentForPaaS`for your VCN and bucket.
...
Open the Region menu and select the region in which you want to create the Oracle PaaS service instance.
...
- From the Compartment list, select the compartment you created.
...
- Click Next .
- Review the list of resources that the workflow will create for you. Notice that the workflow will set up security list rules and route table rules to enable basic access for the VCN.
- Click Create to start the short workflow.
...
- In the Compartment list, select the root compartment of your tenancy.
- Click Create Policy .
- Enter the following:
...
For more information about policies, see[Details for the Resource Manager](https://docs.oracle.com/iaas/Content/Identity/Reference/resourcemanagerpolicyreference.htm)and also[Policy Syntax](https://docs.oracle.com/iaas/Content/Identity/Concepts/policysyntax.htm).
- 

(Optional) If you want to enable the use of an Autonomous AI Transaction Processing or Oracle Cloud Infrastructure Database instance in your compartment as the infrastructure schema database for your Oracle Java Cloud Service instance, then add the following statements:
...
Select the compartment you created.
- 

Select Create Bucket .
- 

Enter a bucket name, for example: PaasBucket .
...
- Copy the token immediately, because you can't retrieve it again after closing the dialog box. Also, make sure you have this token available when you create your Oracle Platform Services instance.
...
For more information about policies, see[Policy Basics](https://docs.oracle.com/iaas/Content/Identity/Concepts/policies.htm#Policy)and also[Policy Syntax](https://docs.oracle.com/iaas/Content/Identity/Concepts/policysyntax.htm).
- 
...
Select the compartment you want to create the bucket in.
- 

Select Create Bucket .
- Enter a bucket name, for example: PaasBucket . Make a note of the name you enter. You need it when you create an instance for your Oracle Platform Service later. Avoid entering confidential information.
- 
...
The new token is displayed.
- Copy the auth token immediately, because you can't retrieve it again after closing the dialog box. Also, make sure you have this token available when you create your Oracle Platform Services instance.
...
Autonomous AI Lakehouse[Getting Started with Autonomous AI Lakehouse](https://docs.oracle.com/en/cloud/paas/autonomous-data-warehouse-cloud/user/getting-started.html#GUID-4B91499D-7C2B-46D9-8E4D-A6ABF2093414)
...
Data Hub Cloud Service[Get Started with Oracle Data Hub Cloud Service](https://docs.oracle.com/en/cloud/paas/data-hub-cloud/index.html)
...
Event Hub Cloud Service[Oracle Event Hub Cloud Service](https://apexapps.oracle.com/pls/apex/f?p=44785:141:7496580165458::::P141_PAGE_ID,P141_SECTION_ID:518,3638)
Integration[Getting Started with Oracle Integration 3](https://docs.oracle.com/pls/topic/lookup?ctx=appint&id=INTRA-GUID-3FD7D407-DA8F-42C3-89DB-6E6E105E271E)
Java Cloud Service[About Java Management Service](https://docs.oracle.com/iaas/jms/doc/java-management-service.html)
