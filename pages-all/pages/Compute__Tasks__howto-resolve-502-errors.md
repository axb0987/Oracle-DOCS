...
- Source: https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/howto-resolve-502-errors.htm
...
In this example, the IP address of the machine to test is 10.0.0.5.
...
If you're using a Load Balancer, ensure the backend sets are in a healthy state and attached. Option 1

From the main menu go to Networking under Load Balancers select Load Balancer .
- Select the load balancer to review.
- On the Load Balancer Details page, check Backend set health status. Option 2
