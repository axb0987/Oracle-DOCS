# Encrypting Data
- Source: https://docs.oracle.com/en-us/iaas/Content/KeyManagement/Tasks/ekms_encryption_data.htm
- Fetched: 2026-09-05 02:34 CDT

# Encrypting Data

Learn how to encrypt data using an AES key.

Use the[Encrypt](https://docs.oracle.com/iaas/api/#/en/key/latest/EncryptedData/Encrypt)API with the Cryptographic Endpoint to encrypt your data using an AES key.
Note  
