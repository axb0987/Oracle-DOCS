...
You can[monitor CPU utilization](https://docs.oracle.com/en-us/iaas/Content/Compute/References/computemetrics.htm)using the`CpuUtilization`metric.

### Supported Shapes

You can use the following[shapes](https://docs.oracle.com/en-us/iaas/Content/Compute/References/computeshapes.htm)to create burstable instances:
- VM.Standard3.Flex
- VM.Standard.E3.Flex
- VM.Standard.E4.Flex
- VM.Standard.E5.Flex
...
VM.Standard3.Flex 1 minimum, 32 OCPU maximum 1 GB minimum, 384 GB maximum 0.5 Gbps for each 12.5% baseline OCPU, overall maximum 32 Gbps
...
Maximum 24 VNICs.
VM.Standard.E3.Flex 1 OCPU minimum, 64 OCPU maximum 1 GB minimum, 768 GB maximum 0.5 Gbps for each 12.5% baseline OCPU, overall maximum 40 Gbps
...
Maximum 24 VNICs.
VM.Standard.E4.Flex 1 OCPU minimum, 64 OCPU maximum 1 GB minimum, 768 GB maximum 0.5 Gbps for each 12.5% baseline OCPU, overall maximum 40 Gbps
...
Maximum 24 VNICs.
VM.Standard.E5.Flex 1 OCPU minimum, 94 OCPU maximum 1 GB minimum, 1049 GB maximum 0.5 Gbps for each 12.5% baseline OCPU, overall maximum 40 Gbps
...
How they scale The instance dynamically scales the available OCPUs between a baseline and a maximum that you define. You must[resize the instance](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/resizinginstances.htm)when you want to scale the OCPUs and memory.
...
Cloud Advisor can recommend converting a regular instance to a burstable instance, as described in[Change Compute Instances to Burstable](https://docs.oracle.com/iaas/Content/CloudAdvisor/Concepts/recommendations-costmanagement.htm#burstable).
...
- Memory does not burst.
- [Custom images](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/managingcustomimages.htm)are supported if the baseline OCPU meets the minimum requirements for the image.
...
- Burstable instances must use[paravirtualized networking](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/instances.htm#instance-network-launch-types). If you create a regular instance using SR-IOV networking (the default for some regular instances), and want to change the instance to a burstable instance, you must also[change the networking type](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/edit-launch-options.htm)to paravirtualized.
- [Service limits](https://docs.oracle.com/iaas/Content/General/service-limits/default.htm)and[compartment quotas](https://docs.oracle.com/iaas/Content/Quotas/Concepts/resourcequotas.htm)for a burstable instance count the baseline OCPUs that are configured for the instance, regardless of actual usage. Burstable instances and regular instances share the same service limits and compartment quotas based on the instance's shape.
- The following features are not available with burstable instances:
- Dedicated virtual machine hosts
- Preemptible capacity
- Capacity reservations
- [Extended memory VM instances](https://docs.oracle.com/en-us/iaas/Content/Compute/References/extended-memory-vm-instances.htm)
...
When you[create an instance](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/launchinginstance.htm), you specify whether the instance is a burstable instance. You can also[edit an existing, regular instance](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/resizinginstances.htm)to make it a burstable instance.
...
- Click Change shape .
- Select a[shape that supports bursting](https://docs.oracle.com/en-us/iaas/Content/Compute/References/burstable-instances.htm#supported-shapes).
- For Number of OCPUs , choose the maximum number of OCPUs for the instance to burst to.
- Select the Burstable option.
- 

In the Baseline utilization per OCPU list, select the baseline OCPU utilization for the instance. This value is the percentage of OCPUs that you want to use most of the time.
