...
In the examples,`InstanceUpdaters`is a policy group that allows updates to instances.
...
- Click the list to select the volume.
Note  
...
- Click the list to select the image.
Note  
