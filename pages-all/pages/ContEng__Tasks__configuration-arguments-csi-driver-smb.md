# CSI Driver SMB
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/configuration-arguments-csi-driver-smb.htm
- Fetched: 2026-09-05 01:53 CDT

# CSI Driver SMB

When you enable the CSI Driver SMB cluster add-on, you can pass the following key/value pairs as arguments.

[Configuration Arguments Common to most Cluster Add-ons](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/configuration-arguments-csi-driver-smb.htm#)
...
[Configuration Arguments Specific to this Cluster Add-on](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/configuration-arguments-csi-driver-smb.htm#)

Key (API and CLI) Key's Display Name (Console) Description Required/Optional Default Value Example Value
`controller.tolerations`tolerations for csi-driver-smb controller Custom tolerations to apply to the CSI Driver SMB controller. Optional
```

```

`controller.affinity`csi-driver-smb controller Node affinity rules for scheduling the CSI Driver SMB controller pod. Optional`null`
