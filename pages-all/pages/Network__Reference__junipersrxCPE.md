# Juniper SRX
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Reference/junipersrxCPE.htm
- Fetched: 2026-09-05 02:42 CDT

# Juniper SRX

This topic provides configuration for a Juniper SRX running software version JunOS 11.0 (or newer).
Important  
...
The configuration template provided is for a Juniper SRX router running JunOS 11.0 software (or later). The template provides information for each tunnel that you must configure. We recommend setting up all configured tunnels for maximum redundancy.
...
[View the configuration template in full screen for easier reading.](https://docs.oracle.com/en-us/iaas/Content/Network/Reference/../non-dita/vpn_cpe_juniper_srx.txt)
