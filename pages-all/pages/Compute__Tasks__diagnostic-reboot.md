...
- Source: https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/diagnostic-reboot.htm
...
Before you send a diagnostic reboot, restart the instance's OS and confirm that the instance is configured correctly. See the[Compute troubleshooting suggestions](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/../References/troubleshooting-compute-instances.htm)and[Networking troubleshooting suggestions](https://docs.oracle.com/iaas/Content/Network/Concepts/troubleshooting.htm). Use diagnostic reboot as a final attempt to troubleshoot an unreachable instance.
...
All VM[shapes](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/../References/computeshapes.htm)except shapes in the dense I/O series support diagnostic reboots.
