...
- Source: https://docs.oracle.com/en-us/iaas/Content/Registry/known-issues/registry-known-issues.htm
...
After September 30, 2019, you will have to use the tenancy namespace rather than the tenancy name when using Oracle Cloud Infrastructure Registry. Background
...
- username is jdoe@acme.com Workaround for logging into Oracle Cloud Infrastructure Registry
...
Use the`docker tag`command to change the repository path by entering:
```
...
Push the image with the new repository path to the Container Registry by entering:
```
