...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/access/working-with-smtp-credentials.htm
...
SMTP credentials don't expire. Each user can have up to two credentials at a time. To get SMTP credentials in the Console, see[Generating SMTP Credentials](https://docs.oracle.com/en-us/iaas/Content/Identity/access/to_generate_SMTP_credentials.htm).
