...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/policyreference/nlbpolicyreference.htm
...
`ListNetworkLoadBalancersHealths`NETWORK_LOAD_BALANCER_READ
`GetNetworkLoadBalancerHealth`NETWORK_LOAD_BALANCER_READ
