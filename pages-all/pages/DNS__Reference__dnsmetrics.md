# DNS Metrics
- Source: https://docs.oracle.com/en-us/iaas/Content/DNS/Reference/dnsmetrics.htm
...
The DNS service metrics help you measure the number of queries and zone transfers for DNS zones and DNS zones with[Overview of Traffic Management](https://docs.oracle.com/en-us/iaas/Content/DNS/Reference/../../TrafficManagement/Concepts/overview.htm)policies attached.
...
Each metric includes one or more of the following dimensions: resourceID The OCID of the zone to which the metric applies. resourceName The name of the zone to which the metric applies.
...
Note: This metric is only emitted at 72 hours, 24 hours, 6 hours, 3 hours, 2 hours and 1 hour until zone expiration.`resourceID, resourceName`
...
- [Viewing Metrics for the DNS Service](https://docs.oracle.com/en-us/iaas/Content/DNS/Reference/view-dns-metrics.htm)
- [Viewing Metrics for a Zone](https://docs.oracle.com/en-us/iaas/Content/DNS/Reference/dnsmetric_topic-view-zone-metrics.htm)
