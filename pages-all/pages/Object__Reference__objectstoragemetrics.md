...
- Source: https://docs.oracle.com/en-us/iaas/Content/Object/Reference/objectstoragemetrics.htm
...
Valid[alarm intervals](https://docs.oracle.com/iaas/Content/Monitoring/Tasks/create-alarm.htm)depend on the frequency at which the metric is emitted. Be sure to set alarm intervals equal to or greater than the frequency at which the metrics are emitted. You can find the emit frequency for each metric in the[Available Metrics: oci_objectstorage](https://docs.oracle.com/en-us/iaas/Content/Object/Reference/objectstoragemetrics.htm#metrics-list)and[Available Metrics: oci_objectstorage](https://docs.oracle.com/en-us/iaas/Content/Object/Reference/objectstoragemetrics.htm#metrics-list)tables.

the following table shows the terms and their descriptions that are part of each metric:Each metric includes the following dimensions :

Term Description
Resourced The OCID of the bucket to which the metric applies.
ResourcedDisplayNameRESOURCEDISPLAYNAME The name of the bucket .
Tier The storage tier (standard or archive) where the object resides.
...
Description/ Emit Frequency Dimensions
...
Emit frequency: every hour`resourceID`
...
Emit frequency: every 100 ms`resourceID`
