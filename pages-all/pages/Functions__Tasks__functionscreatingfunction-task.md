# Creating a Function
- Source: https://docs.oracle.com/en-us/iaas/Content/Functions/Tasks/functionscreatingfunction-task.htm
- Fetched: 2026-09-05 02:08 CDT

# Creating a Function

Find out how to create functions in the OCI Functions server from an existing Docker image that has already been pushed to the Docker registry.

For prerequisites and more information, see[Creating Functions](https://docs.oracle.com/en-us/iaas/Content/Functions/Tasks/functionscreatingfunctions-about.htm).

- [Console](https://docs.oracle.com/en-us/iaas/Content/Functions/Tasks/functionscreatingfunction-task.htm#)
- [CLI](https://docs.oracle.com/en-us/iaas/Content/Functions/Tasks/functionscreatingfunction-task.htm#)
- [API](https://docs.oracle.com/en-us/iaas/Content/Functions/Tasks/functionscreatingfunction-task.htm#)
- 
