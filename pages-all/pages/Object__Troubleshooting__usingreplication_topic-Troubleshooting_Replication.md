...
- Source: https://docs.oracle.com/en-us/iaas/Content/Object/Troubleshooting/usingreplication_topic-Troubleshooting_Replication.htm
...
- The destination bucket can't have versioning enabled.
- The destination bucket can't have retention rules.
...
Review the existing policies that grant user and service permissions. For more information, see[Required IAM Policies](https://docs.oracle.com/en-us/iaas/Content/Object/Troubleshooting/../Tasks/usingreplication.htm#permissions).
