# Decrypting Data
- Source: https://docs.oracle.com/en-us/iaas/Content/KeyManagement/Tasks/usingkeys_topic-To_decrypt_data_by_using_your_Vault_master_encryption_key.htm
...
- [Console](https://docs.oracle.com/en-us/iaas/Content/KeyManagement/Tasks/usingkeys_topic-To_decrypt_data_by_using_your_Vault_master_encryption_key.htm#)
- [CLI](https://docs.oracle.com/en-us/iaas/Content/KeyManagement/Tasks/usingkeys_topic-To_decrypt_data_by_using_your_Vault_master_encryption_key.htm#)
- [API](https://docs.oracle.com/en-us/iaas/Content/KeyManagement/Tasks/usingkeys_topic-To_decrypt_data_by_using_your_Vault_master_encryption_key.htm#)
- 
...
Open a command prompt and run[oci kms crypto decrypt](https://docs.oracle.com/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/kms/crypto/decrypt.html)to decrypt data.
...
Use the[Decrypt](https://docs.oracle.com/iaas/api/#/en/key/latest/DecryptedData/Decrypt)API with the Cryptographic Endpoint to decrypt data.
Note  
