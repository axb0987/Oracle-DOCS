# Access Token
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/AccessToken.htm
...
`exp`The time (UNIX epoch time) when the JWT expires (in seconds). See the[Token Expiry Table](https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/TokenExpiryTable.htm).
...
The custom token expiry is still subject to the overall access token expiry rules. See the[Token Expiry Table](https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/TokenExpiryTable.htm).
