# Send Requests
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/SendRequests.htm
...
Where:`domainURL`represents the domain-specific URL. To get this URL using the identity domains Console, see[Finding an Identity Domain URL](https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/locate-identity-domain-url.htm).
...
Or the request signatures in the Authorization header Access tokens are very long strings. This example has been truncated:`Bearer VkdVAZrb_fw......eyJ4NXQjUzI1Ni`
