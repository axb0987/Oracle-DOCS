...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/mfa/configure-security-questions.htm
...
- On the Authentication page, in the Security questions row, select Edit .
- Under Edit security questions settings, set options for answer length and the number of questions a user is asked.
The minimum number of security questions that a user must set up is three.
Note  
  
This value can't be changed using the user interface. If you need to change this number, you must use the`/SecurityQuestionSettings`API endpoint.
...
- Under Manage security questions , select the Language in which you want to view the questions.
- Under Default questions, select the checkboxes for the preconfigured questions that you want to use.
To disable a default security question, clear the checkbox for that question.
- To add a custom security question, select Add question and then follow these steps:
...
- Select the Actions menu (three dots) of the question and select Delete .
-
