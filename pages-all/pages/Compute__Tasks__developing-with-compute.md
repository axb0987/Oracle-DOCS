...
- Source: https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/developing-with-compute.htm
...
- Autoscaling:[Autoscaling](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/autoscalinginstancepools.htm)lets you automatically adjust the number or the lifecycle state of compute instances in an instance pool.
- Compute instance agent (Oracle Cloud Agent): Oracle Cloud Agent is a lightweight process that manages[plugins running on compute instances](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/manage-plugins.htm). Plugins collect performance metrics, install OS updates, and perform other instance management tasks.
