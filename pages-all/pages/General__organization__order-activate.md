# Activating an Order
- Source: https://docs.oracle.com/en-us/iaas/Content/General/organization/order-activate.htm
...
Run the[ActivateOrder](https://docs.oracle.com/iaas/api/#/en/organizations/latest/Order/ActivateOrder)
