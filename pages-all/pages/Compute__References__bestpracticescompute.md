...
- Source: https://docs.oracle.com/en-us/iaas/Content/Compute/References/bestpracticescompute.htm
...
- Create a[custom image](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/managingcustomimages.htm)of your system drive each time you change the image.
- [Back up](https://docs.oracle.com/iaas/Content/Block/Tasks/create-bv-backup.htm)your data drives, or sync to spare drives, regularly. If you experience a hardware failure and have followed these practices, you can terminate the failed instance, launch your custom image to create a new instance, and then apply the backup data.
...
With Linux instances, you can[use SSH to access your instance](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/connect-to-linux-instance.htm)from a remote host. Default users names are assigned based on the Linux distribution used.
...
If you do not want to share SSH keys, you can[create additional SSH-enabled users](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/addingusers.htm).

With Windows instances, you can[access your instance using a Remote Desktop client](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/connect-to-windows-instance.htm). If you used a Windows platform image to create the instance, the username is`opc`. After signing in, you can add users on your instance.

For more information about user access, see[Adding Users to an Instance](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/addingusers.htm).
...
Oracle Cloud Infrastructure supports a variety of maintenance actions for compute instances including non-terminating repair, live migration, scheduled maintenance, rebuild in place, and manual migration. The maintenance action depends on characteristics such as the[shape](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../References/computeshapes.htm)that the instance uses. Depending on the type of maintenance action that is performed for an instance, the instance might experience downtime during infrastructure maintenance. For some shapes, you can control how and when the downtime occurs. For more information, see[Instance Maintenance](https://docs.oracle.com/en-us/iaas/Content/Compute/References/infrastructure-maintenance.htm).

You can use compute infrastructure health metrics to monitor the status of your instances during maintenance. For more information, see[Infrastructure Health Metrics](https://docs.oracle.com/en-us/iaas/Content/Compute/References/infrastructurehealthmetrics.htm)
