...
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengsettingupnativeingresscontroller-140migrationnotes.htm
- Fetched: 2026-09-05 01:56 CDT

# Notes about OCI Native Ingress Controller Version 1.4.0

Find out about the changes in OCI native ingress controller version 1.4.0, and the preparatory steps that you might have to perform before upgrading to version 1.4.0.
...
After performing any preparatory steps, you have to manually update the OCI native ingress controller cluster add-on to version 1.4.0 using the Console, the CLI, or the API (see[Updating a Cluster Add-on](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/update-add-on.htm)
