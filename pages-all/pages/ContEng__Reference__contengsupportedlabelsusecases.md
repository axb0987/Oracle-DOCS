...
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Reference/contengsupportedlabelsusecases.htm
- Fetched: 2026-09-05 01:53 CDT

# Supported Labels for Different Usecases

Find out about the labels that Kubernetes Engine (OKE) uses when creating and managing clusters.
...
Note that the`node.kubernetes.io/exclude-from-external-load-balancers`
