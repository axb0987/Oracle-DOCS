...
Find out about the prerequisites you have to meet before you can use Container Registry.
...
- You must either belong to a group to which a policy grants the appropriate permissions, or belong to the tenancy's Administrators group. See[Policies to Control Repository Access](https://docs.oracle.com/en-us/iaas/Content/Registry/Concepts/registrypolicyrepoaccess.htm).
- You must have an Oracle Cloud Infrastructure auth token. If you don't have an auth token already, see[Getting an Auth Token](https://docs.oracle.com/en-us/iaas/Content/Registry/Concepts/../Tasks/registrygettingauthtoken.htm).
...
- `https://af-casablanca-1.ocir.io`(OC1 realm only)
- `https://lej.ocir.io`(OC1 realm only)
- `https://artifacts.af-casablanca-1.oci.oraclecloud.com`
...
- `https://ap-batam-1.ocir.io`(OC1 realm only)
- `https://hsg.ocir.io`(OC1 realm only)
- `https://artifacts.ap-batam-1.oci.oraclecloud.com`
Japan Central (Osaka)
...
- `https://ap-kulai-2.ocir.io`(OC1 realm only)
- `https://jbp.ocir.io`(OC1 realm only)
- `https://artifacts.ap-kulai-2.oci.oraclecloud.com`
Singapore (Singapore)
...
- `https://eu-madrid-3.ocir.io`(OC1 realm only)
- `https://orf.ocir.io`(OC1 realm only)
- `https://artifacts.eu-madrid-3.oci.oraclecloud.com`
...
Italy North (Turin)
- `https://eu-turin-1.ocir.io`(OC1 realm only)
- `https://nrq.ocir.io`(OC1 realm only)
- `https://artifacts.eu-turin-1.oci.oraclecloud.com`
