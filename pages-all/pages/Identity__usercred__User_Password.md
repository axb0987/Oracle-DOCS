# User Password
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/usercred/User_Password.htm
...
For more information, see[Unblocking a User](https://docs.oracle.com/en-us/iaas/Content/Identity/usercred/../access/to_unblock_a_user.htm).
...
If you're an administrator who needs to reset a user's Console password, see[Unblocking a User](https://docs.oracle.com/en-us/iaas/Content/Identity/usercred/../access/to_unblock_a_user.htm).
...
If automatic account unlock is not enabled for the identity domain by the password policy, the user must contact an administrator to get unblocked (see[Unblocking a User](https://docs.oracle.com/en-us/iaas/Content/Identity/usercred/../access/to_unblock_a_user.htm)
