...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/appgateways/enable-session-persistence-sticky-cookies.htm
...
- Enable the sticky module in App Gateway by editing the file`/usr/local/nginx/conf/nginx.conf`.
