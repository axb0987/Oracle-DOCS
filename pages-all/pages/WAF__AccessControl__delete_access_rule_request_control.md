# Deleting a Request Control Rule from a Web Application Firewall Policy
- Source: https://docs.oracle.com/en-us/iaas/Content/WAF/AccessControl/delete_access_rule_request_control.htm
- Fetched: 2026-09-05 03:09 CDT

# Deleting a Request Control Rule from a Web Application Firewall Policy

Remove a request control rule from a web application firewall policy.
...
- From the Actions menu (three dots) for the request access rule, select Delete .
-
