...
If you have problems deleting a compartment, see[Compartment Fails to Delete](https://docs.oracle.com/en-us/iaas/Content/Identity/compartments/../troubleshooting/compartments.htm#Troubleshooting_compartment_fails_to_delete).
...
- For the compartment you want to delete, select the Actions menu (three dots) , and then select Delete .
- At the prompt, select Delete .
...
Run the[DeleteCompartment](https://docs.oracle.com/iaas/api/#/en/identity/latest/Compartment/DeleteCompartment)
