...
- Source: https://docs.oracle.com/en-us/iaas/Content/WAF/IPAddressWhitelists/delete_IP_address_whitelist.htm
...
- [Console](https://docs.oracle.com/en-us/iaas/Content/WAF/IPAddressWhitelists/delete_IP_address_whitelist.htm#)
- [CLI](https://docs.oracle.com/en-us/iaas/Content/WAF/IPAddressWhitelists/delete_IP_address_whitelist.htm#)
- [API](https://docs.oracle.com/en-us/iaas/Content/WAF/IPAddressWhitelists/delete_IP_address_whitelist.htm#)
- 
...
- Select the check box for one or more IP address allowlists you want to delete, and then select Delete .

Alternatively, select the Actions menu (three dots) for the IP address allowlist you want to delete and select Delete .
- Confirm the deletion.

The IP Address Whitelist list no longer includes those IP address allowlists you deleted.
...
Use the[UpdateWhitelists](https://docs.oracle.com/iaas/api/#/en/waas/latest/Whitelist/UpdateWhitelists)operation to delete an IP address whitelist from an edge policy using the API.
