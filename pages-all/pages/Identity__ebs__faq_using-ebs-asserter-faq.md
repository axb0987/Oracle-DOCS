...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/ebs/faq_using-ebs-asserter-faq.htm
...
See[Updating the E-Business Suite Asserter Configuration File](https://docs.oracle.com/en-us/iaas/Content/Identity/ebs/update-ebs-asserter-configuration-file.htm).
...
Yes, Proxy configuration are configured in the`bridge.properties`file. See[Updating the E-Business Suite Asserter Configuration File](https://docs.oracle.com/en-us/iaas/Content/Identity/ebs/update-ebs-asserter-configuration-file.htm).
