...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/oraclecloudservices/overview.htm
...
When you purchase an Oracle Cloud Service, the service appears on the Oracle Cloud Services page in the Console.
...
For a comprehensive list of the available Oracle Cloud SaaS, DaaS, PaaS, and IaaS services, go to[https://www.oracle.com/cloud](https://www.oracle.com/cloud)and from the Oracle Cloud menu, select that category of services that interests you. From the page that opens, you can find links to detailed information about each service.
...
- [Listing Oracle Cloud Services](https://docs.oracle.com/en-us/iaas/Content/Identity/oraclecloudservices/list-cloud-service.htm)
- [Activating Oracle Cloud Services](https://docs.oracle.com/en-us/iaas/Content/Identity/oraclecloudservices/activating-oracle-cloud-services.htm)
- [Deactivating Oracle Cloud Services](https://docs.oracle.com/en-us/iaas/Content/Identity/oraclecloudservices/deactivating-oracle-cloud-services.htm)
