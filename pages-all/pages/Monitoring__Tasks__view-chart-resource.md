...
- Source: https://docs.oracle.com/en-us/iaas/Content/Monitoring/Tasks/view-chart-resource.htm
...
Select the name of the instance that you want to see metrics for.
- 

On the instance details page, under Resources , select Metrics .
