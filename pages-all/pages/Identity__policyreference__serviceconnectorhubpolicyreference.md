...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/policyreference/serviceconnectorhubpolicyreference.htm
...
Connector Hub supports all the general variables (see[General Variables](https://docs.oracle.com/en-us/iaas/Content/Identity/policyreference/policyreference_topic-General_Variables_for_All_Requests.htm)), plus the ones listed here.

The`serviceconnectors`resource type can use the following variables.

Variable Variable Type Comments
`target.serviceconnector.id`OCID

Use this variable to control access for connectors.
...
SERVICE_CONNECTOR_CREATE

SERVICE_CONNECTOR_DELETE

SERVICE_CONNECTOR_MOVE
