# Editing an Attribute of an Events Rule
- Source: https://docs.oracle.com/en-us/iaas/Content/Events/Task/update-attribute-events-rule.htm
- Fetched: 2026-09-05 02:02 CDT

# Editing an Attribute of an Events Rule

Update an attribute for a rule.
...
- [Console](https://docs.oracle.com/en-us/iaas/Content/Events/Task/update-attribute-events-rule.htm#)
- [CLI](https://docs.oracle.com/en-us/iaas/Content/Events/Task/update-attribute-events-rule.htm#)
- [API](https://docs.oracle.com/en-us/iaas/Content/Events/Task/update-attribute-events-rule.htm#)
- 
...
- Under Attributes , select the checkbox next to the attributes you want to edit.
Tip  
