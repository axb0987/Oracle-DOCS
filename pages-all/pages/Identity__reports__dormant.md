...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/reports/dormant.htm
...
This just shows users who have signed in to IAM using their IAM credentials (username and password, or username and second factor). Usernames of federated users signing in using an identity provider aren't displayed.
