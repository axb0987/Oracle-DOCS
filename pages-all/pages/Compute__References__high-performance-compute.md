...
- Source: https://docs.oracle.com/en-us/iaas/Content/Compute/References/high-performance-compute.htm
...
You can create a single-node HPC instance with the standard instance creation workflow. If you want to use multiple HPC instances in a RDMA network group, you can create them through a[Cluster Networks with Instance Pools](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/managingclusternetworks.htm)or[Compute Clusters](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/compute-clusters.htm). You can also deploy[GPU memory clusters](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Concepts/gpu-memory-fabric.htm#top), transforming a group of GPUs into a single AI supercomputer that can handle AI and high performance computing workloads.
...
- [Cluster networks with instance pools](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/managingclusternetworks.htm)let you use instance pools to manage groups of identical instances in the RDMA network group. If you want predictable capacity for a specific number of identical instances that are managed as a group, use cluster networks with instance pools.
- [Compute clusters](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/compute-clusters.htm)let you manage instances in the cluster individually. When you create a compute cluster, you create an empty RDMA network group. After the group is created, you can add instances to the group, or delete instances from the group. If you want to manage instances in the RDMA network independently of each other or use different types of instances in the network group, use compute clusters.

## Using GPU Memory Clusters

To support AI and high performance computing workloads, you can also deploy[GPU memory clusters](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Concepts/gpu-memory-fabric.htm#top)alongside your[compute clusters](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/compute-clusters.htm). GPU memory clusters let you group and manage instances that use specialized architecture and operate as unified hosts within a shared, high-performance GPU memory fabric domain, enabling ultra-high-bandwidth, low-latency communication.

The hosts that are part of the GPU memory cluster are instantiated as part of the specified (and required) compute cluster, and operate in a hardware-isolated domain for security.
...
Supported shapes and images for HPC
...
BM.Optimized3.36 Ubuntu 20.04+, OL7, OL8 Enabled on OCA 1.37.0 or above The sub-modules of the HPC plugin can be individually enabled or disabled:
- Auto Configuration
...
To enable the HPC plugin on an existing bare metal instance, you must create or migrate the existing instance to Oracle Cloud Agent 1.35.0 or above. See[Oracle Cloud Agent](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/manage-plugins.htm)for more information.
...
For a detailed list of HPC metrics, see[Compute Instance Metrics](https://docs.oracle.com/en-us/iaas/Content/Compute/References/computemetrics.htm)
