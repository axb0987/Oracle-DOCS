...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/applications/use-regular-expressions.htm
...
In this example, the URLs`/mybank/myCredits`and`/mybank/myDebits`match the`/mybank/my.*`pattern, but`/mybank/about`
