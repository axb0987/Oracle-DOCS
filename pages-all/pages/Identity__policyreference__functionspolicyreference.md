...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/policyreference/functionspolicyreference.htm
...
OCI Functions supports all the general variables (see[General Variables](https://docs.oracle.com/en-us/iaas/Content/Identity/policyreference/policyreference_topic-General_Variables_for_All_Requests.htm)).
...
FN_FUNCTION_LIST`ListFunctions`
...
`CreateApplication`FN_APP_CREATE
`DeleteApplication`FN_APP_DELETE
`ListApplication`FN_APP_LIST
`GetApplication`FN_APP_READ
`UpdateApplication`FN_APP_UPDATE
