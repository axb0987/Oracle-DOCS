...
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Reference/ciscoasaCPEroutebased.htm
- Fetched: 2026-09-05 02:42 CDT

# Cisco ASA: Route-Based

This topic provides a route-based configuration for a Cisco ASA running software version 9.7.1 (or newer).
Important  
...
This section covers important characteristics and limitations that are specific to Cisco ASA. See[Limits by Service](https://docs.oracle.com/iaas/Content/General/service-limits/default.htm)for a list of applicable limits and instructions for requesting a limit increase.
...
This section covers general characteristics and limitations of Site-to-Site VPN. See[Limits by Service](https://docs.oracle.com/iaas/Content/General/service-limits/default.htm)for a list of applicable limits and instructions for requesting a limit increase.
...
The configuration template provided is for a Cisco router running Cisco ASA 9.7.1 software (or later). The template provides information for each tunnel that you must configure. We recommend setting up all configured tunnels for maximum redundancy.
...
- Configure internal routing that routes traffic between the CPE and the on-premises network.
- Ensure that you permit traffic between the ASA and the Oracle VCN.
...
Oracle provides a separate configuration template for IKEv1 and IKEv2.
...
[View the IKEv1 configuration template in full screen for easier reading.](https://docs.oracle.com/en-us/iaas/Content/Network/Reference/../non-dita/vpn_cpe_ciscoasa_route_based.txt)
...
[View the IKEv2 configuration template in full screen for easier reading.](https://docs.oracle.com/en-us/iaas/Content/Network/Reference/../non-dita/vpn_cpe_ciscoasa_ikev2_route_based.txt)
