# Updating a Boot Volume Backup
- Source: https://docs.oracle.com/en-us/iaas/Content/Block/Tasks/bootv-backup-edit.htm
- Fetched: 2026-09-05 01:45 CDT

# Updating a Boot Volume Backup

Edit the configuration of a boot volume backup.
Note  
...
- [Console](https://docs.oracle.com/en-us/iaas/Content/Block/Tasks/bootv-backup-edit.htm#)
- [CLI](https://docs.oracle.com/en-us/iaas/Content/Block/Tasks/bootv-backup-edit.htm#)
- [API](https://docs.oracle.com/en-us/iaas/Content/Block/Tasks/bootv-backup-edit.htm#)
- 

Edit the following boot volume backup options using the console.
- On the Boot Volume Backups list page, locate the backup you want to work with. If you need help finding the list page, see[Listing Boot Volume Backups](https://docs.oracle.com/en-us/iaas/Content/Block/Tasks/list-bv-boot-volume-backup.htm).
...
Use the[`oci bv boot-volume-backup update`](https://docs.oracle.com/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/bv/boot-volume-backup/update.html)command and specify the`--boot-volume-backup-id`parameter to edit a boot volume backup:
...
Run the[`UpdateBootVolumeBackup`](https://docs.oracle.com/iaas/api/#/en/iaas/latest/BootVolumeBackup/UpdateBootVolumeBackup)operation to update a boot volume backup.
