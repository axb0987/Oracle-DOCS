...
- Source: https://docs.oracle.com/en-us/iaas/Content/Streaming/Tasks/get-stream-pool.htm
...
- [Console](https://docs.oracle.com/en-us/iaas/Content/Streaming/Tasks/get-stream-pool.htm#)
- [CLI](https://docs.oracle.com/en-us/iaas/Content/Streaming/Tasks/get-stream-pool.htm#)
- [API](https://docs.oracle.com/en-us/iaas/Content/Streaming/Tasks/get-stream-pool.htm#)
- 
...
- (Optional) To view Kafka Connect configuration values, select the Kafka connection settings tab.
- 

Use the[oci streaming admin stream-pool get](https://docs.oracle.com/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/streaming/admin/stream-pool/get.html)command and required parameters to get details for a stream pool:
...
Run the[GetStreamPool](https://docs.oracle.com/iaas/api/#/en/streaming/latest/StreamPool/GetStreamPool)operation to get details for a stream pool.
...
[About Resource Manager and Terraform](https://docs.oracle.com/en-us/iaas/Content/Streaming/Tasks/get-stream-pool.htm#)
