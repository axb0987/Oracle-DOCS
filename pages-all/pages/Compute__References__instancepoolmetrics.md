...
- Source: https://docs.oracle.com/en-us/iaas/Content/Compute/References/instancepoolmetrics.htm
...
Resources: Compute[instance pools](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/creatinginstancepool.htm).
...
Depending on the metric, the following dimensions are available: AvailabilityDomain The availability domain where the instance pool resides. DisplayName The friendly name of the instance pool. FaultDomain The fault domain where the instance pool resides. region The region where the instance pool resides. resourceId The OCID of the instance pool.

Metric Metric Display Name Unit Description Dimensions
`InstancePoolSize`Instance Pool Size instances Number of instances in the pool.
...
`resourceId`
`ProvisioningInstances`Instances Provisioning instances Number of instances in the pool that are provisioning.
...
`resourceId`
`RunningInstances`Instances Running instances Number of running instances in the pool.
...
`resourceId`
`TerminatedInstances`Instances Terminated instances Number of instances in the pool that are terminating or terminated.
...
For Metric namespace , select`oci_instancepools`.
