...
Learn about how the Oracle Cloud Infrastructure is hosted in regions and availability domains. Regions are localized geographic areas, and availability domains are one or more data centers within a region.
...
Regions are grouped into realms . Your tenancy exists in a single realm and can access all regions that belong to that realm. You can't access regions that aren't in your realm. Currently, Oracle Cloud Infrastructure has multiple realms, including commercial,[government](https://docs.oracle.com/iaas/Content/General/Concepts/govlanding.htm), and[dedicated](https://docs.oracle.com/en-us/iaas/Content/General/Concepts/dedicatedregions.htm)realms.
...
Morocco West (Casablanca) af-casablanca-1 Casablanca, Morocco LEJ OC1 1
...
Spain Central (Madrid 3) eu-madrid-3 Madrid, Spain ORF OC1 1
...
To subscribe to a region, see[Managing Regions](https://docs.oracle.com/iaas/Content/Identity/Tasks/managingregions.htm).
...
[Oracle UK Sovereign Cloud](https://docs.oracle.com/iaas/Content/gov-cloud/govuksouth.htm)
- 
...
In general: IAM resources are cross-region. DB Systems, instances, and volumes are specific to an availability domain. Everything else is regional. Exception: Subnets were originally designed to be specific to an availability domain. Now, you can create[regional subnets](https://docs.oracle.com/iaas/Content/Network/Tasks/create_subnet.htm), which are what Oracle recommends.
...
- catalog items (Fleet Application Management)
...
- cloudevents-rules
- compliance policy rules (Fleet Application Management)
- config work requests (Log Analytics)
...
- iot-domain-groups (Internet of Things)
- internet gateways
...
- node pools
- notebook sessions
- object collection rules (Log Analytics)
- OpenSearch clusters (Search with OpenSearch)
- OpenSearch cluster backups (Search with OpenSearch)
- patches (Fleet Application Management)
- platform configurations (Fleet Application Management)
- osddistributeddb (Globally Distributed AI Database)
- osddistributeddbprivateendpoint (Globally Distributed AI Database)
- osdworkrequest (Globally Distributed AI Database)
- port scans
...
- provisions (Fleet Application Management)
- queryjob work requests (Log Analytics)
- queues
...
- service gateways
- sessions (Bastion)
- sharded-database (Globally Distributed Autonomous AI Database)
- sharded-database-work-request (Globally Distributed Autonomous AI Database)
- sharded-database-private-endpoint (Globally Distributed Autonomous AI Database)
...
- storage work requests (Log Analytics)
...
- Lustre file systems (File Storage with Lustre)
- network firewalls
