# Overview of IAM
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/identity-domains.htm
...
Watch a[video introduction](https://apexapps.oracle.com/pls/apex/f?p=44785:265:0:::265:P265_CONTENT_ID:31681)to the service.
...
- Adaptive security:[Activate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../adaptivesecurity/activate-adaptive-security.htm)and[Deactivate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../adaptivesecurity/deactivate-adaptive-security.htm)
- App Gateway:[Activate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../appgateways/activate-app-gateways.htm)and[Deactivate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../appgateways/deactivate-app-gateways.htm).
- Applications:[Activate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../applications/activate-applications.htm)and[Deactivate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../applications/deactivate-applications.htm)
- Identity domains:[Deactivate and reactivate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../domains/to-deactivate-a-domain.htm)
- Identity providers:[Activating or Deactivating an Identity Provider](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../identityproviders/activate-identity-provider.htm)
- Microsoft AD Bridge:[Activate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../msadbridge/activate-microsoft-active-directory-ad-bridge.htm)and[Deactivate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../msadbridge/deactivate-microsoft-active-directory-ad-bridge.htm)
- Risk providers:[Activate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../adaptivesecurity/activate-risk-provider.htm)and[Deactivate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../adaptivesecurity/deactivate-risk-provider.htm)
- Self-registration profiles:[Activate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../selfregistrationprofiles/deactivating-self-registration-profiles.htm)
- Sign-on policies:[Activate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../signonpolicies/activate-sign-policies.htm)and[Deactivate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../signonpolicies/deactivate-sign-policies.htm)
- Terms of use:[Activate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../termsofuse/activate-terms-use.htm)and[Deactivate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../termsofuse/deactivate-terms-use.htm)
- Users:[Deactivate and reactivate](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/identity-domains.htm#activate-and-deactivate)
...
- Whether your OCI tenancy has been updated to use Oracle Cloud Infrastructure Identity and Access Management (OCI IAM) identity domains
...
- Sign in to the Oracle Cloud Console. Need help signing in? See[Sign In to the Console](https://docs.oracle.com/iaas/Content/GSG/Tasks/signingin.htm).
- In the navigation menu navigation menu , select Identity &amp; Security . Under Identity , check for Domains . If you see Domains , your cloud account has been updated.
...
- To administer IAM in tenancies with identity domains, see[Oracle Cloud Infrastructure Identity and Access Management](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../home.htm).
- For user self-service instructions, such as setting up MFA, see the[IAM User Guide](https://docs.oracle.com/en-us/iaas/Content/Identity/getstarted/../using/aboutidentitydomains.htm).
When using the API:
...
To use the Console to administer IAM in tenancies without identity domains, see[Overview of Identity and Access Management](https://docs.oracle.com/iaas/Content/Identity/Concepts/overview.htm).

To use the API to administer IAM in tenancies without identity domains, see[IAM API](https://docs.oracle.com/iaas/api/#/en/identity/).

For information about what to expect when the update happens, see[OCI IAM Identity Domains: What OCI IAM customers need to know](https://www.oracle.com/a/ocom/docs/security/what-oci-iam-customers-should-expect.pdf).
...
To use the API to administer stripes in IDCS, see[REST API for Oracle Identity Cloud Service](https://docs.oracle.com/en/cloud/paas/identity-cloud/rest-api/index.html).

For information about what to expect when the migration happens, see[OCI IAM Identity Domains: What Oracle IDCS customers need to know](https://www.oracle.com/a/ocom/docs/security/what-idcs-customers-should-expect.pdf)
