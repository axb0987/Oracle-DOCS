...
- Source: https://docs.oracle.com/en-us/iaas/Content/Object/Tasks/understandingnamespaces.htm
...
The namespace metadata stores the default compartment assignments for the Amazon S3 Compatibility API and the Swift API. For more information, see[Compartments for the Amazon S3 Compatibility API and Swift API](https://docs.oracle.com/en-us/iaas/Content/Object/Tasks/designatingcompartments.htm).
...
In the navigation bar, select the Profile menu and then select Tenancy: &lt;your_tenancy_name&gt; . Your namespace string is listed in the tenancy's details page.
Note  
  
While the Object Storage namespace string is displayed, you can't edit the namespace string. The namespace string appears here for information only.
- 
...
Use the[GetNamespace](https://docs.oracle.com/iaas/api/#/en/objectstorage/latest/Namespace/GetNamespace)operation to get your Object Storage namespace. If you have the`OBJECTSTORAGE_NAMESPACE_READ`permission and supply the compartment or tenancy OCID in the optional`compartmentId`
