...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/adaptivesecurity/understand-risk-providers.htm
...
- Impossible travel between locations As an example, if a person uses a new, unknown device to sign in, the system doesn't recognize the device, and will the trigger the Access from an unknown login device event.
