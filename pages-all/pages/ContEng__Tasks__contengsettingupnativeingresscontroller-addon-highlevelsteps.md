...
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengsettingupnativeingresscontroller-addon-highlevelsteps.htm
- Fetched: 2026-09-05 01:56 CDT

# High Level Steps to Set Up the OCI Native Ingress Controller as a Cluster Add-on

Find out the high level steps to set up the OCI native ingress controller as a cluster add-on to load balance and route incoming traffic to service pods running on worker nodes in a cluster.
...
For more information, see[Prerequisites for deploying the OCI Native Ingress Controller as a Cluster Add-on](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengsettingupnativeingresscontroller-addon-prereqs.htm).
- 
