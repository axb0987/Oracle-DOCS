...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/managinggrouprolesidcs.htm
...
- Select the name of the group you want to add roles to.
- 

On the group details page, select Manage Roles . The Manage Roles page displays the list of services for which you have Administrator access. The service and instance roles that this group has already been granted are also displayed.

Note that you won't see services that you don't have Administrator access for.
- Find the service you want to edit this group's access to, select the Actions menu (three dots) , and then select Manage service access . The list of roles for the selected service is displayed.
- 

Select each role that you want to assign to the group.
- Select Save Role Selections .
- To add more service roles to this group, repeat steps 6 - 8.
- Select Apply Role Settings .
- 

In the confirmation dialog, select Send Email to Group to send an email to each member of the group to notify them of this change.
...
The list of groups is displayed.
- Select the name of the group you want to remove roles from.
- 

On the group details page, select Manage Roles . The Manage Roles page displays the list of services for which you have Administrator access. The service and instance roles that this group has already been granted are also displayed.

Note that you won't see services that you don't have Administrator access for.
- Find the service you want to edit this group's access to, select the Actions menu (three dots) , and then select Manage service access or Manage instance access , as appropriate. The list of roles for the selected service is displayed.
- 

Clear the checkbox for each role you want remove from the group.
- Select Save Role Selections or Update Instance Settings , as appropriate..
- To revoke more service or instance roles from this group, repeat steps 6 - 8.
- Select Apply Role Settings .
- A confirmation dialog displays the services that you modified access to in this session. Select Close .
...
Note that you won't see services that you don't have Administrator access for.
- Find the service with instances that you want to edit this group's access to, select the Actions menu (three dots) , and then select Manage instance access . The list of instances for the selected service is displayed.
- 

On the Manage Access to Instances page, find the name of the instance you want to edit this group's access to.
- 
