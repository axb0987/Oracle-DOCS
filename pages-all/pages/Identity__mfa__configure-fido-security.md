...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/mfa/configure-fido-security.htm
...
- On the Authentication page, in the Fast ID Online (FIDO) passkey authenticator row, select Edit .
- Configure the FIDO authenticator settings:
