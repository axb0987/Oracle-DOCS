# Listing TSIG Keys
- Source: https://docs.oracle.com/en-us/iaas/Content/DNS/Tasks/tsig-key-list.htm
...
- Open the navigation menu and select Networking . Under DNS management , select TSIG keys .
...
Use filters to limit the TSIG keys in the list. Perform one of the following actions depending on the options that you see:
...
In the list table, select the name of a TSIG key to open its details page, where you can view its status and perform other tasks.

To create another TSIG keys, select Create TSIG key .

To perform other actions on a TSIG key directly from the list table, you can also select any of the following options from the Actions menu (three dots) in the row for that TSIG key:
- View details : Open the details page for the TSIG key.
- Copy OCID : Copy the OCID of the TSIG key to the clipboard.
- Move resource : See[Moving a TSIG Key Between Compartments](https://docs.oracle.com/en-us/iaas/Content/DNS/Tasks/tsig-key-move.htm#top).
...
- Delete : See[Deleting a TSIG Key](https://docs.oracle.com/en-us/iaas/Content/DNS/Tasks/tsig-key-delete.htm#top).
- 
...
Run the[ListTsigKeys](https://docs.oracle.com/iaas/api/#/en/dns/latest/TsigKey/ListTsigKeys)
