...
- Source: https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/update-csp-bb-server.htm
...
Use the`[](https://docs.oracle.com/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/resource-manager/configuration-source-provider/update-bitbucket-server-access-token-provider.html)oci resource-manager configuration-source-provider update-bitbucket-server-access-token-provider`command and required parameters to update a configuration source provider from Bitbucket Server .
