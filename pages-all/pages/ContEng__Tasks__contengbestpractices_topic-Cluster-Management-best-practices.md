...
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengbestpractices_topic-Cluster-Management-best-practices.htm
- Fetched: 2026-09-05 01:54 CDT

# Cluster Management Best Practices

Find out about best practices for managing clusters you've created by Kubernetes Engine (OKE).
...
See[Tagging Kubernetes Cluster-Related Resources](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengtaggingclusterresources.htm).
...
Note that before Full Stack Disaster Recovery was released, we previously recommended the use of third-party tools (such as[Kasten](https://www.kasten.io),[Rancher](https://www.rancher.com/),[Trilio](https://trilio.io/), or[Velero](https://velero.io/)
