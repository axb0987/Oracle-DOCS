...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/passwordpolicies/modify-custom-password-policy.htm
...
- On the Password policy list page, select the name of the policy you want to change. If you need help finding the list page, see[Listing Password Policies](https://docs.oracle.com/en-us/iaas/Content/Identity/passwordpolicies/listing-password-policies.htm).
- To change the description and priority of the password policy, select Edit password policy , make the necessary changes, and then select Save changes .
- To change the password rules, select Edit password rules and proceed with the rest of the steps.
- Select Custom and edit the criteria in the following list:
...
- Select Save changes .
- (Recommended): In the Save password policy dialog box, select Force all users to set a new password on their next login .
