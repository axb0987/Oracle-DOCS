...
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/vtap.htm
...
- An[Autonomous AI Lakehouse](https://docs.oracle.com/en/cloud/paas/autonomous-database/serverless/index.html)instance using a private endpoint
- A[Network Firewall](https://docs.oracle.com/iaas/Content/network-firewall/overview.htm)
Note  
  
When you create a VTAP, the source OCID must match the selected source type. For Compute instances, specify the OCID of the attached VNIC. For the other source types, specify the service resource's OCID. For example, if the source type is Network Firewall, specify the network firewall OCID.
...
For more information, see[Capture Filters](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/../Concepts/capture-filters.htm).
...
### VTAPs
- [Creating a VTAP](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/vtap-create.htm)
- [Listing VTAPs](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/vtap-list.htm)
- [Updating a VTAP](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/vtap-update.htm)
- [Starting or Stopping a VTAP](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/vtap-turning-vtap-on-or-off.htm)
- [Moving a VTAP to a Different Compartment](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/vtap-move.htm)
- [Deleting a VTAP](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/vtap-delete.htm)

### Capture Filters
- [Creating a Capture Filter](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/capture-filter-create.htm)
- [Updating a Capture Filter](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/capture-filter-update.htm)
- [Moving a Capture Filter to a Different Compartment](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/capture-filter-move.htm)
- [Deleting a Capture Filter](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/capture-filter-delete.htm)
