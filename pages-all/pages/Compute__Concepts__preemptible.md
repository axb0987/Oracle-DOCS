...
- Source: https://docs.oracle.com/en-us/iaas/Content/Compute/Concepts/preemptible.htm
...
To use preemptible capacity, follow the standard process for[creating an instance](https://docs.oracle.com/en-us/iaas/Content/Compute/Concepts/../Tasks/launchinginstance.htm), and for Capacity type , select Preemptible capacity .
...
- The following features or instance types are not available with preemptible instances:
- Bare metal instances.
- Burstable instances.
- Capacity reservations.
- Confidential computing.
- Dedicated virtual machine hosts.
- [Extended memory VM instances](https://docs.oracle.com/en-us/iaas/Content/Compute/Concepts/../References/extended-memory-vm-instances.htm).
- Sending diagnostic interrupts.
- Instances that have a minimum billing time.
- You cannot create[instance configurations](https://docs.oracle.com/en-us/iaas/Content/Compute/Concepts/instancemanagement.htm), or use preemptible instances in[instance pools](https://docs.oracle.com/en-us/iaas/Content/Compute/Concepts/instance-pools.htm).
- Instance migration after infrastructure maintenance events is not supported. During maintenance events that impact the underlying infrastructure, the capacity is reclaimed, and the instance is terminated.
...
The policies that let users create instances also allow them to create preemptible instances. For details, see[Required IAM Policy for Working with Instances](https://docs.oracle.com/en-us/iaas/Content/Compute/Concepts/../Tasks/instances.htm#instance-permissions).
...
- Perform the initial steps to[create an instance](https://docs.oracle.com/en-us/iaas/Content/Compute/Concepts/../Tasks/launchinginstance.htm).
...
- For Image and shape , choose a[shape](https://docs.oracle.com/en-us/iaas/Content/Compute/Concepts/preemptible.htm#howitworks__supported-preemptible-shapes)that supports preemptible instances.
...
See[Terminating an Instance](https://docs.oracle.com/en-us/iaas/Content/Compute/Concepts/../Tasks/terminatinginstance.htm).
