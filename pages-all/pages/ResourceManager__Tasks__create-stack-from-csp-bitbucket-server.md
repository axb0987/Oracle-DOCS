...
- Source: https://docs.oracle.com/en-us/iaas/Content/ResourceManager/Tasks/create-stack-from-csp-bitbucket-server.htm
...
- From the Actions menu (three dots) for the configuration source provider, select Create stack from configuration source provider .
