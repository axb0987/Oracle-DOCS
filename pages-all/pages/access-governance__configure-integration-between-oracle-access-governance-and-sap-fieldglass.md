# Configure Integration Between Oracle Access Governance and SAP Fieldglass
- Source: https://docs.oracle.com/en-us/iaas/Content/access-governance/configure-integration-between-oracle-access-governance-and-sap-fieldglass.htm
...
You can establish a connection between SAP Fieldglass and Oracle Access Governance by entering connection details. To achieve this, use the orchestrated systems functionality available in the Oracle Access Governance Console.
...
Enter details of the connection to your SAP Fieldglass system.
- On the Integration settings step of the workflow, enter the details required to allow Oracle Access Governance to connect to your SAP Fieldglass system.

Integration settings
Parameter Name Description

Host The host of your SAP Fieldglass service instance. For example:
```
...
Client ID Username you use to connect to SAP Fieldglass

Client secret Password you use to connect to SAP Fieldglass
