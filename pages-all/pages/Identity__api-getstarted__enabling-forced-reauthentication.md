...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/enabling-forced-reauthentication.htm
...
When OCI IAM is federated to an external identity provider, OCI IAM can't guarantee if a user is forced to reauthenticate by an external identity provider. The behavior depends on how OIDC/SAML protocols are implemented at the external identity provider.
