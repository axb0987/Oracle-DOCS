...
- Source: https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/custom-images-list.htm
...
- For a custom image, from the Actions menu (three dots), export the custom image, create an instance from the custom image, or delete the custom image.
- 
