...
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengmodifyingnodepool.htm
- Fetched: 2026-09-05 01:55 CDT

# Modifying Node Pool and Worker Node Properties

Find out how to modify properties of existing node pools and worker nodes you've created using Kubernetes Engine (OKE).
...
- how pods in the node pool communicate with each other using a pod subnet (when the cluster's Network type is VCN-native pod networking )
...
When you change the Kubernetes version configured for a managed node pool, you can select either a newer Kubernetes version to upgrade managed nodes or an earlier available Kubernetes version to roll back managed nodes. Existing managed nodes continue to run their current Kubernetes version until you replace them. For more information, see[Upgrading Managed Nodes to a Newer Kubernetes Version](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengupgradingk8sworkernode.htm)and[Rolling Back Managed Nodes to an Earlier Kubernetes Version](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengupgradingimageworkernode_Rolling-Back.htm).
...
- [Updating a Managed Node Pool](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/update-node-pool.htm)
- [Updating a Virtual Node Pool](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/update-virtual-node-pool.htm)
