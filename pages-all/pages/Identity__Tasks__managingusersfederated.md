...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/Tasks/managingusersfederated.htm
...
- Open the navigation menu and select Identity &amp; Security . Under Identity , select Users . A list of the users in your tenancy is displayed.
- Find the user you want to delete and select the Actions menu (three dots) .
- Select Delete .
