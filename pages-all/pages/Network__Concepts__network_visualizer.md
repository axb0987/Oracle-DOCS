# Network Visualizer
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Concepts/network_visualizer.htm
...
Virtual Private Network (IPSec) connection
...
Oracle region
Resource outside the region or compartment or filtered because of a service limit (details aren't visible)
...
Load balancers and Compute instances in a subnet aren't shown in this view. That level of detail is shown in the subnet maps.
...
Private Load Balancer (LB)
Mount Target (MT)
Kubernetes Cluster (OKE)
Compute instance (I)
Security list (SL)

SLs are shown the left side of the resource list while in Security mode.
Network security groups (NSG)

NSGs are shown on the right side of the resource list while in Security mode.

## Documenting Your Network

Network Visualizer has a Export Map Data function that exports a zip file containing a high-resolution PNG map of the resources in the current region and compartment, and a PDF file containing a lower-resolution version of the map plus resource data (such as route tables detailing the IP address ranges used in the VCN or VCNs). The PDF includes only the resource information for the elements shown in the map at the time of export.

This feature is available for a tenancy's:
- Regional Network Topology Map
- VCN Topology Map
- Subnet Topology Map

You can use the information supplied by these maps to track changes to the network implementation, or to re-implement the network configuration elsewhere.

## Network Visualizer Tasks
- [Viewing a Regional Network Topology Map](https://docs.oracle.com/en-us/iaas/Content/Network/Concepts/../Tasks/view-network-topology-map.htm)
- [Viewing a VCN Topology Map](https://docs.oracle.com/en-us/iaas/Content/Network/Concepts/../Tasks/view-vcn-topology-map.htm)
- [Viewing a Subnet Topology Map](https://docs.oracle.com/en-us/iaas/Content/Network/Concepts/../Tasks/view-subnet-topology-map.htm)
