...
- Source: https://docs.oracle.com/en-us/iaas/Content/DNS/Tasks/view-create.htm
...
- On the Private views list page, select Create private view . If you need help finding the list page, see[Listing Views](https://docs.oracle.com/en-us/iaas/Content/DNS/Tasks/view-list.htm#top).
- In the Create private view panel, enter the following values:
...
Run the[CreateView](https://docs.oracle.com/iaas/api/#/en/dns/latest/View/CreateView)
