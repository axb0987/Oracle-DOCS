# Tagging Resources
- Source: https://docs.oracle.com/iaas/Content/dev/terraform/tagging-resources.htm
- Fetched: 2026-09-05 19:21 CDT

# Tagging Resources

Use tagging with the Oracle Cloud Infrastructure Terraform provider.
...
[Free-form tags](https://docs.oracle.com/iaas/Content/Tagging/Concepts/understandingfreeformtags.htm)can be applied by any user with permissions on the resource. Freeform tags are simple key/value map.
