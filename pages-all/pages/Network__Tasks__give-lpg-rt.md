...
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/give-lpg-rt.htm
...
- Select the name of the route table you're interested in.
- On the Route tables details page, perform one of the following actions depending on the option that you see:

- Select the Route Rules tab.
- Under Resources , select Route Rules .
- Select Add Route Rules and enter the following values:
...
Any subnet traffic with a destination that matches the rule is routed to the LPG. For general information about setting up route rules, see[VCN Route Tables](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/managingroutetables.htm).

If you no longer need the peering and want to delete the LPG, you must first delete all route rules in the VCN that specify the LPG as a target.
- 
