...
- Source: https://docs.oracle.com/en-us/iaas/Content/Compute/References/bringyourownimage.htm
...
- [Importing Custom Windows Images](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/importingcustomimagewindows.htm)
- [Importing Custom Linux Images](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/importingcustomimagelinux.htm)
...
- [Create a custom image](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/custom-images-create.htm)of your instance.
- 

[Edit the image capabilities for the custom image](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/configuringimagecapabilities.htm)to use the following settings:
...
For steps to import a Windows image, see[Importing Custom Windows Images](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/importingcustomimagewindows.htm).

Bring your own license (BYOL) for Windows Server is permitted when launching a VM instance on a shared host or when launching a VM instance on a dedicated host. For more information about BYOL and the licensing requirements for Windows images,[Microsoft Licensing on Oracle Cloud Infrastructure](https://docs.oracle.com/en-us/iaas/Content/Compute/References/microsoftlicensing.htm).
...
Bring your own hypervisor deployment of ESXi on bare metal compute instances is not supported. ESXi is supported only by provisioning an Oracle Cloud VMware Solution software-defined data center (SDDC). See[VMware Solution](https://docs.oracle.com/iaas/Content/VMware/Concepts/ocvsoverview.htm)for more information.
...
To bring your own KVM, first[create a bare metal instance](https://docs.oracle.com/en-us/iaas/Content/Compute/References/../Tasks/launchinginstance.htm)using the KVM image from Marketplace. Then, copy your on-premises guest OS to KVM on the bare metal instance. For more information, see[Oracle Linux Virtualization](https://docs.oracle.com/en/virtualization/index.html).
