...
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/update-rules-routetable.htm
...
- On the route table details page, perform one of the following actions depending on the option that you see:

- Select the Route Rules tab.
- Under Resources , select Route Rules .
- To create a route rule, select Add Route Rules , and enter the following information:
...
- To edit an existing rule, depending on the option that you see:
