...
- Source: https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/importingcustomimagelinux.htm
...
- [Create a custom image](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/../Tasks/custom-images-create.htm)of your instance.
- 

[Edit the image capabilities for the custom image](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/../Tasks/configuringimagecapabilities.htm)to use the following settings:
...
Support from Red Hat and OCI through the Red Hat Certified Cloud and Service Provider (CCSP) program: for versions and shapes, see[Red Hat Ecosystem Catalog - Oracle Cloud Infrastructure](https://catalog.redhat.com/cloud/detail/216977)
...
- Identify the RHEL versions and Compute shapes that are supported by reviewing[Red Hat Ecosystem Catalog - Oracle Cloud Infrastructure](https://catalog.redhat.com/cloud/detail/216977).
- Download a supported version of RHEL from the[Red Hat Customer Portal](https://access.redhat.com/downloads/). The image format must be the KVM guest image.
- [Upload the image to a bucket](https://docs.oracle.com/iaas/Content/Object/Tasks/managingobjects_topic-To_upload_objects_to_a_bucket.htm)in Object Storage. We recommend that you create a separate bucket dedicated to RHEL images.
- 
...
- [Set the custom image to be compatible with the shapes](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/managingcustomimages.htm#Managing_Custom_Images__console-custom-image-tasks)that are supported for the image.
- [Create an instance](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/managingcustomimages.htm#Managing_Custom_Images__console-custom-image-tasks)that uses the RHEL custom image and a supported shape.
- [Connect to the instance](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/connect-to-linux-instance.htm). The default username is`cloud-user`.
...
- If you want to use the image on AMD or X6-based[shapes](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/../References/computeshapes.htm), then add the shapes to the image's[list of compatible shapes](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/managingcustomimages.htm#Managing_Custom_Images__console-custom-image-tasks).
...
- If you enabled serial console access to the image, test it by[creating a serial console connection to the instance](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/../References/serialconsole.htm).

See the[current issues and workarounds](https://docs.oracle.com/en-us/iaas/Content/Compute/Tasks/../known-issues.htm)
