...
All of them, including IAM itself. You can find specific details for writing policies for each service in the[IAM Policies Overview](https://docs.oracle.com/en-us/iaas/Content/Identity/Concepts/../policieshow/Policy_Basics.htm).
...
See[To delete a compartment](https://docs.oracle.com/en-us/iaas/Content/Identity/Concepts/../Tasks/managingcompartments.htm#To_delete_a_compartment).
