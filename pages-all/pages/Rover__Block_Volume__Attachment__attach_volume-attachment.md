...
- Source: https://docs.oracle.com/en-us/iaas/Content/Rover/Block_Volume/Attachment/attach_volume-attachment.htm
...
Select Attached Block Volumes in the lower left corner. The Attached Block Volumes page appears. All attached block volumes are listed in tabular form.
- 

Select Attach Block Volume . The Attach Block Volume dialog box appears. By default, the attached block volume type is Paravirtualized .
- 

Choose the volume selection option:
- 
...
Select a Device Path : Choose one from the list of device paths. For example:
...
Run the[AttachVolume](https://docs.oracle.com/iaas/api/#/en/iaas/latest/VolumeAttachment/AttachVolume)
