...
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengfaqs.htm
- Fetched: 2026-09-05 01:55 CDT

# Frequently Asked Questions About Kubernetes Engine (OKE)

Find out answers to frequently asked questions about Kubernetes Engine (OKE).
...
You can continue to create such clusters using the CLI or API (until the date specified in the Service Change Announcement[here](https://docs.oracle.com/iaas/Content/servicechanges.htm#servicechanges_topic_oke)), but not the Console. Note that you can only create these clusters as basic clusters, not as enhanced clusters.
...
For a detailed comparison of virtual nodes and managed nodes, see[Comparing Virtual Nodes with Managed Nodes](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengcomparingvirtualwithmanagednodes_topic.htm)
