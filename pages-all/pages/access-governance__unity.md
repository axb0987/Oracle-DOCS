...
- Source: https://docs.oracle.com/en-us/iaas/Content/access-governance/unity.htm
...
Perform Oracle Unity account updates. Create, Update (organization), Enable, Disable, and Delete accounts from within Oracle Access Governance. See[Manage Account Lifecycle with Service Desk Executive Support](https://docs.oracle.com/en-us/iaas/Content/access-governance/manage-identities.htm#manage-account-lifecycle-with-service-desk-executive-support).
- Access Control :
...
Enable users to view and update their own profile attributes using Oracle Access Governance, with updates reflected in Oracle Unity. See[View Access Details and Manage Account](https://docs.oracle.com/en-us/iaas/Content/access-governance/view-access-details-and-manage-account.htm)
- Access Reviews and Attestation :

Periodically review and certify Oracle Unity user access to ensure appropriate entitlements. See[Access Reviews Overview](https://docs.oracle.com/en-us/iaas/Content/access-governance/key-features.htm#access-reviews).
...
See[Configure Integration with Oracle Unity](https://docs.oracle.com/en-us/iaas/Content/access-governance/unity-configure-integrate-unity.htm).
- 
