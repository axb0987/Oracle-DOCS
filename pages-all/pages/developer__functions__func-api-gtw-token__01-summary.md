...
- Source: https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm
...
[OCI Account Requirements](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
- [Functions: Get Started using Cloud Shell](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/../func-setup-cs/01-summary.htm)
- [Functions: Get Started using the CLI](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/../func-setup-cli/01-summary.htm)
...
[Software Requirements](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Get Compartment Information](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Collected Information](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Create Functions Application](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Setup Ingress Rule for HTTPS](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Setup Policy for API Gateway Access to Functions](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Create "Hello World" Python Function](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Create the API Gateway](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Create an API Deployment for your Gateway](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Test your API Gateway](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Review Starting Python Code](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Create Functions Configuration Variable](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
For more information about setting function configuration values, see[Fn Project's tutorial on runtime context](https://fnproject.io/tutorials/basics/UsingRuntimeContext/).

[Update Required Packages and Handler Function](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)

First, update the`func.py`for required packages.
- Update the`import`statements in`func.py`for required packages validation:
...
- Next, remove the main body of the function. The`response`method and related code are added back as we progress.
...
[Add Validation Code to Function](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)
...
[Test your Function](https://docs.oracle.com/en-us/iaas/Content/developer/functions/func-api-gtw-token/01-summary.htm#)

- Redeploy the updated function.
- Invoke the function to ensure that the function is working.
- Update the`gtw01.sh`script to pass the`POST`data to the script.

```

```

- Run the script:`gtw01.sh | jq`
- If the API keys match, the output from the script looks similar to:
...
You can download the complete source code for the function from the[Oracle Function Samples site here](https://github.com/oracle/oracle-functions-samples/tree/master/samples/oci-apigw-apikey-validation-python).
...
You have successfully created an API Gateway and called a function from it. You updated the function to validate an API key.
