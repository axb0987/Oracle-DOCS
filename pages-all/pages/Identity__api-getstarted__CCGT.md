...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/CCGT.htm
...
See[Client Credentials Grant Type Authorization Flow Example](https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/CCGT.htm#ClientCredServerAppAuth)for an example flow.
...
See[Client Credentials Grant Type](https://docs.oracle.com/en-us/iaas/Content/Identity/api-getstarted/CCGT.htm)for more information on the Client Credentials grant type and an authorization flow diagram.
