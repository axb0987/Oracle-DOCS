...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/applications/access-all-resources.htm
...
To generate a refresh token in addition to the access token, use the scope`urn:opc:resource:consumer::all offline_access`
