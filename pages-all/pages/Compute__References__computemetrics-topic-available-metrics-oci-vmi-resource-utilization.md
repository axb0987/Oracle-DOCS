...
- Source: https://docs.oracle.com/en-us/iaas/Content/Compute/References/computemetrics-topic-available-metrics-oci-vmi-resource-utilization.htm
...
If the[Monitoring](https://docs.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#metrics)service is down, data may be lost until the service is restored.
...
The metric includes the following dimensions : resourceId The OCID of the instance.
...
`System`Every 60 seconds Yes Yes
...
`Available`Every 60 seconds Yes Yes
...
`Reads/writes times`Every 60 seconds Yes Yes
`VNIC`VNIC
