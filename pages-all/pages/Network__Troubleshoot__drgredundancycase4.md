...
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Troubleshoot/drgredundancycase4.htm
...
You use FastConnect to connect your on-premises network to a VCN. Although you might have multiple virtual circuits in this connection, only one of them is up (the BGP status is UP). Your connection to Oracle is at risk when routine maintenance is performed on the Oracle router.
