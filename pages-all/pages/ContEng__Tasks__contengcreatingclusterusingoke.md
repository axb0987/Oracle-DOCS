...
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengcreatingclusterusingoke.htm
...
In addition to using the 'Quick Create' and 'Custom Create' workflows in the Console, you can also create clusters using the CLI and the API. For more information, see[Creating a Cluster](https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/create-cluster.htm)
