...
- Source: https://docs.oracle.com/en-us/iaas/Content/Streaming/Tasks/streaming-quickstart-oci-sdk-for-javascript.htm
- Fetched: 2026-09-05 03:06 CDT

# SDK for JavaScript Streaming Quickstart

Publish and consume messages in the Streaming service using OCI SDK for JavaScript.
...
Open a command prompt that has`npm`in its path, change to the directory where you want to keep your code for this quickstart (`wd`, for example), and then run the following command to install the OCI SDK for JavaScript:
...
- Open your favorite editor, such as Visual Studio Code, from the directory`wd`. You should already have`oci-sdk`packages for JavaScript installed in this directory after you've met the[prerequisites](https://docs.oracle.com/en-us/iaas/Content/Streaming/Tasks/streaming-quickstart-oci-sdk-for-javascript.htm#prerequisites-javascript).
- 

Create a file named`Producer.js`in the`wd`directory with following code. Replace values of variables`ociConfigFile`,`ociProfileName`,`ociStreamOcid`, and`ociMessageEndpointForStream`in the following code snippet with the values applicable for your tenancy.
...
- First, ensure that the stream you want to consume messages from contains messages. You could[use the Console to produce a test message](https://docs.oracle.com/en-us/iaas/Content/Streaming/Tasks/publishingmessages.htm#console), or use the stream and messages we[created in this quickstart](https://docs.oracle.com/en-us/iaas/Content/Streaming/Tasks/streaming-quickstart-oci-sdk-for-javascript.htm#produce-messages-javascript).
- Open your favorite editor, such as Visual Studio Code, from the directory`wd`. You should already have the`oci-sdk`packages for JavaScript installed in this directory after you've met the[prerequisites](https://docs.oracle.com/en-us/iaas/Content/Streaming/Tasks/streaming-quickstart-oci-sdk-for-javascript.htm#prerequisites-javascript).
- 

Create a file named`Consumer.js`in directory`wd`with following code. Replace values of variables`ociConfigFile`,`ociProfileName`,`ociStreamOcid`, and`ociMessageEndpointForStream`in the following code snippet with the values applicable for your tenancy.
...
- [OCI SDK for JavaScript on GitHub](https://github.com/oracle/oci-typescript-sdk)
- OCI SDK for[JavaScript](https://github.com/oracle/oci-typescript-sdk/blob/master/examples/javascript/streaming.js)
