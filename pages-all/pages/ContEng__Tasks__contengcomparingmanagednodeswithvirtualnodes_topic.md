...
- Source: https://docs.oracle.com/en-us/iaas/Content/ContEng/Tasks/contengcomparingmanagednodeswithvirtualnodes_topic.htm
- Fetched: 2026-09-05 01:54 CDT

# Comparing Managed Nodes with Virtual Nodes

Find out about the differences between the managed nodes and virtual nodes you can create using Kubernetes Engine (OKE).
...
- Pod Networking: Both the VCN-Native Pod Networking CNI plugin and the flannel CNI plugin are supported. Configuring secondary VNICs for pod networking using Application Resources is supported when using VCN-native pod networking.
