...
- Source: https://docs.oracle.com/en-us/iaas/Content/Identity/tutorials/okta/okta_tutorials.htm
...
Be sure to read the Before You Begin sections in each tutorial so that you have everything you need to complete them successfully. You can perform the tutorials in any order.
...
- [JIT Provisioning from Okta to OCI IAM](https://docs.oracle.com/en-us/iaas/Content/Identity/tutorials/okta/jit_okta/okta_jit.htm)
Note
