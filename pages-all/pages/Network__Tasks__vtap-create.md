# Creating a VTAP
- Source: https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/vtap-create.htm
...
- On the VTAPs list page, select Create VTAP . If you need help finding the list page, see[Listing VTAPs](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/vtap-list.htm#top).
...
- [Autonomous AI Lakehouse](https://docs.oracle.com/en/cloud/paas/autonomous-database/serverless/index.html)
- [Network Firewall](https://docs.oracle.com/iaas/Content/network-firewall/overview.htm)
...
After you select the resource type, use the lists to select the subnet of the current VCN where the resource's IP address or endpoint is located, and the specific resource.
- Capture Filter: Either select an existing capture filter or select to[create a capture filter](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/capture-filter-create.htm). A new capture filter needs a name, a compartment, and at least one rule.
- (Optional) Select Show advanced options and provide the following information as needed:
...
When using the CLI, you must[create a capture filter](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/capture-filter-create.htm)before you create the VTAP.
...
The`--vcn-id`parameter identifies the VCN that contains the resources used by the VTAP. The`--source-id`parameter identifies the selected source resource. For a complete list of flags and variable options for CLI commands, see the[CLI Command Reference](https://docs.oracle.com/iaas/tools/oci-cli/latest/oci_cli_docs/).
- 

When using the API, you must[create a capture filter](https://docs.oracle.com/en-us/iaas/Content/Network/Tasks/capture-filter-create.htm)before you create the VTAP.

Run the[CreateVtap](https://docs.oracle.com/iaas/api/#/en/iaas/latest/Vtap/CreateVtap)
